...
`,Nt="glass-hub-theme";function zt(t,e=8){return Math.abs(t)>e}const Pt=36e5,Ft=new Set(["unavailable","unknown","none",""]);function jt(t){if(!Array.isArray(t))return[];const e=[];for(const i of t){if(!i||"object"!=typeof i)continue;const t=i,a="number"==typeof t.total?t.total:Number(t.total);if(!Number.isFinite(a)||"string"!=typeof t.startsAt)continue;const r=new Date(t.startsAt);Number.isNaN(r.getTime())||e.push({start:r,ore:100*a})}return e.sort((t,e)=>t.start.getTime()-e.start.getTime())}function Dt(t){if(t.length<3)return null;let e=1/0,i=-1;for(let a=0;a+3<=t.length;a++){let r=!0,s=t[a].ore;for(let e=a+1;e<a+3;e++){if(t[e].start.getTime()-t[e-1].start.getTime()!==Pt){r=!1;break}s+=t[e].ore}r&&s<e&&(e=s,i=a)}return i<0?null:{start:t[i].start,end:new Date(t[i+3-1].start.getTime()+Pt)}}function Ht(t,e,i){if(Ft.has(String(e??"").toLowerCase()))return{now:null,level:"normal",today:[],tomorrow:[],cheapestWindow:null};const a=jt(t?.today),r=jt(t?.tomorrow);if(0===a.length&&0===r.length)return{now:null,level:"normal",today:[],tomorrow:[],cheapestWindow:null};const s=[...a,...r].sort((t,e)=>t.start.getTime()-e.start.getTime()),n=i.getTime(),o=s.find(t=>t.start.getTime()<=n&&n<t.start.getTime()+Pt)??null;let l="normal";if(o&&a.length){const t=a.reduce((t,e)=>t+e.ore,0)/a.length;if(t>0){const e=o.ore/t;e<.85?l="låg":e>1.15&&(l="hög")}}const c=s.filter(t=>t.start.getTime()+Pt>n);return{now:o,level:l,today:a,tomorrow:r,cheapestWindow:Dt(c)}}const It=new Intl.DateTimeFormat("sv-SE",{weekday:"long",day:"numeric",month:"long"});class Ot extends vt{constructor(){super(...arguments),this._now=new Date}connectedCallback(){super.connectedCallback(),this._interval=window.setInterval(()=>{this._now=new Date},3e4)}disconnectedCallback(){super.disconnectedCallback(),void 0!==this._interval&&(clearInterval(this._interval),this._interval=void 0)}get _timeStr(){return`${String(this._now.getHours()).padStart(2,"0")}:${String(this._now.getMinutes()).padStart(2,"0")}`}get _dateStr(){return function(t){return t.length?t.charAt(0).toUpperCase()+t.slice(1):t}(It.format(this._now))}get _weatherStr(){const t=this.weatherEntity?this.getEntity(this.weatherEntity):void 0;if(!t||!this.hass)return"";const e=this.hass.formatEntityState(t),i=t.attributes.temperature;return[e,"number"==typeof i?`${Math.round(i)}°`:""].filter(Boolean).join(" ")}render(){const t=this._weatherStr;return V`
    ...
    `],t([gt({attribute:!1})],Ot.prototype,"weatherEntity",void 0),t([bt()],Ot.prototype,"_now",void 0),customElements.define("hub-clock",Ot);const Ut=t=>X`
...
`,Rt={lamp:Ut(X`
  ...
  `)};class Bt extends ct{constructor(){super(...arguments),this.icon="",this.label="",this.tone="neutral",this.active=!1}render(){const t=Rt[this.icon];return V`
    ...
    `],t([gt({attribute:!1})],qt.prototype,"players",void 0),t([bt()],qt.prototype,"_now",void 0),customElements.define("hub-now-playing",qt);const Wt=new Intl.NumberFormat("sv-SE");function Yt(t,e){return e>0?Math.max(0,Math.min(100,t/e*100)):0}class Kt extends vt{_goto(){this.dispatchEvent(new CustomEvent("hub-goto-page",{detail:{page:"kcal"},bubbles:!0,composed:!0}))}render(){if(!this.hass)return V``;const t=this.todayEntity?this.getEntity(this.todayEntity):void 0,e=t?Number(t.state):NaN;if(!t||"unavailable"===t.state||"unknown"===t.state||Number.isNaN(e))return V`
      ...
      `;const i="number"==typeof t.attributes.kcal_target?t.attributes.kcal_target:0,a=Yt(e,i),r=function(t){const e=t.protein_g;return"number"==typeof e?`${Math.round(e)} g protein`:""}(t.attributes);return V`
    ...
    `],t([gt({attribute:!1})],Kt.prototype,"todayEntity",void 0),customElements.define("hub-kcal-ring",Kt);const Zt={cleaning:"Städar",returning:"Åker hem",paused:"Pausad",error:"Fel",idle:"Väntar"};class Jt extends vt{constructor(){super(...arguments),this._now=new Date}connectedCallback(){super.connectedCallback(),this._interval=window.setInterval(()=>{this._now=new Date},6e4)}disconnectedCallback(){super.disconnectedCallback(),void 0!==this._interval&&(clearInterval(this._interval),this._interval=void 0)}get _chips(){const t=this.config,e=[],i=t.lights_count_entity?this.getEntity(t.lights_count_entity):void 0,a=i&&!Number.isNaN(Number(i.state))?Number(i.state):null;e.push({icon:"lamp",label:null===a?"—":`${a} ${1===a?"lampa":"lampor"}`,tone:"amber",active:(a??0)>0});const r=t.price_entity?this.getEntity(t.price_entity):void 0,s=r&&!Number.isNaN(Number(r.state))?Math.round(100*Number(r.state)):null,n=t.price_series_entity?this.getEntity(t.price_series_entity):void 0,o=n?Ht(n.attributes,n.state,this._now):null,l=o?.now?o.level:"normal",c="låg"===l?" · lågt":"hög"===l?" · högt":"";if(e.push({icon:"bolt",label:null===s?"— öre":`${s} öre${c}`,tone:"låg"===l?"green":"hög"===l?"coral":"neutral",active:null!==s}),t.vacuum_entity){const i=this.getEntity(t.vacuum_entity);i&&"docked"!==i.state&&"unavailable"!==i.state&&"unknown"!==i.state&&e.push({icon:"vacuum",label:Zt[i.state]??"Städar",tone:"error"===i.state?"coral":"neutral",active:!0})}if(t.departures&&function(t,e="06:30",i="09:30"){const a=t.getDay();if(0===a||6===a)return!1;const r=60*t.getHours()+t.getMinutes(),s=t=>{const[e,i]=t.split(":").map(Number);return 60*e+i};return r>=s(e)&&r<=s(i)}(this._now,t.departures.window?.start,t.departures.window?.end)){const i=this.getEntity(t.departures.next_entity),a=i&&i.state&&"unavailable"!==i.state?i.state:"—";e.push({icon:"train",label:a,tone:"neutral",active:!0})}if(t.person_entity){const i=this.getEntity(t.person_entity),a=(i?.attributes.friendly_name||"Philip").split(" ")[0],r="home"===i?.state;e.push({icon:"home",label:`${a} ${r?"hemma":"borta"}`,tone:"neutral",active:!1})}return e}render(){if(!this.hass||!this.config)return V``;const t=this.config;return V`
      <div class="page">
        <div class="top">
    ...
    `}render(){if(!this.hass||!this.config)return V``;const t=this.config,e=function(t,e){let i=0,a=0;for(const r of t.rooms??[])for(const t of r.lights){const r=e[t.entity];te(r)&&(a+=1,"on"===r.state&&(i+=1))}return{on:i,total:a}}(t,this.hass.states);return V`
      <div class="page">
        <div class="header">
          <div class="heading">
          ...
          <div class="actions">
            ${(t.scenes??[]).map(t=>V`
                ...
                >
                  ${Rt[t.icon]?V`<span class="ic">${Rt[t.icon]}</span>`:q}
                  <span>${t.name}</span>
                </button>
              `)}
            <button
    ...
    `}_quiet(){return V`
      <div class="quiet">
        <span class="qic">${Rt.note}</span>
        <span class="qtext">Ingenting spelas</span>
      </div>
    `}render(){if(!this.hass||!this.config)return V``;const t=this._players,e=this.hass.states,i=this._selId(),a=i?e[i]:void 0,r=t.find(t=>t.entity===i)?.name??"",s=!!a&&!le.has(a.state),n=function(t,e){for(const i of e)if("playing"===t[i.entity]?.state)return i.entity;return e[0]?.entity??null}(e,t),o=function(t,e){if(!t)return"none";const[i,a,r]=t;return`radial-gradient(80% 60% at 30% 20%, rgba(${i}, ${a}, ${r}, ${"natt"===e?"0.22":"0.12"}), transparent 70%)`}(this._rgb,this._theme());return V`
      <div class="page">
  ...
  `,t([gt({attribute:!1})],pe.prototype,"points",void 0),t([gt()],pe.prototype,"stroke",void 0),t([gt({type:Number})],pe.prototype,"width",void 0),t([gt({type:Number})],pe.prototype,"height",void 0),customElements.define("hub-sparkline",pe);const ue=new Intl.NumberFormat("sv-SE"),ge=new Intl.NumberFormat("sv-SE",{minimumFractionDigits:1,maximumFractionDigits:1}),be=new Intl.NumberFormat("sv-SE",{maximumFractionDigits:1}),me=new Intl.DateTimeFormat("sv-SE",{day:"numeric",month:"short",timeZone:"UTC"}),ve=new Intl.DateTimeFormat("sv-SE",{weekday:"long",day:"numeric",month:"long",timeZone:"UTC"});function fe(t){if(!t)return"";const e=new Date(`${t}T00:00:00Z`);return Number.isNaN(e.getTime())?"":me.format(e).replace(/\.$/,"")}class xe extends vt{_meals(t){const e=t.attributes.meals;return Array.isArray(e)?e.filter(t=>!!t&&"object"==typeof t).map(t=>({name:"string"==typeof t.name?t.name:"",kcal:"number"==typeof t.kcal?t.kcal:Number(t.kcal)||0})).filter(t=>t.name):[]}_num(t){return"number"==typeof t?t:NaN}_offline(){return V`
    ...
    `}render(){if(!this.hass||!this.config)return V``;const t=this.config.kcal?.today_entity,e=t?this.getEntity(t):void 0,i=e?Number(e.state):NaN;if(!e||"unavailable"===e.state||"unknown"===e.state||Number.isNaN(i))return this._offline();const a=this._num(e.attributes.kcal_target),r=Yt(i,a),s=Number.isFinite(a)&&a>0,n=s?a-i:NaN,o=s?n>0?`${ue.format(Math.round(n))} kcal kvar`:0===n?"Målet nått":`${ue.format(Math.round(-n))} över målet`:null,l=this._num(e.attributes.protein_g),c=this._num(e.attributes.protein_target_g),h=Number.isFinite(l)&&Number.isFinite(c)&&c>0,d=h?Math.max(0,Math.min(100,l/c*100)):0,p=this._meals(e),u=e.attributes.date,g="string"!=typeof u||Number.isNaN(new Date(`${u}T00:00:00Z`).getTime())?"":ve.format(new Date(`${u}T00:00:00Z`));return V`
      <div class="page">
        <div class="header">
...
`;class _e extends vt{constructor(){super(...arguments),this.room=null,this._onScrim=t=>{t.target===t.currentTarget&&this._close()}}_close(){this.dispatchEvent(new CustomEvent("hub-popup-close",{bubbles:!0,composed:!0}))}render(){if(!this.room||!this.hass)return V``;const t=this.room;return V`
    ...
    `],t([gt({attribute:!1})],_e.prototype,"room",void 0),customElements.define("hub-room-popup",_e);const we={hem:{label:"Hem",icon:"home",tone:"neutral"},ljus:{label:"Ljus",icon:"lamp",tone:"amber"},media:{label:"Media",icon:"note",tone:"teal"},energi:{label:"Energi",icon:"bolt",tone:"green"},kcal:{label:"Kcal",icon:"ring",tone:"lavender"}};class $e extends ct{constructor(){super(...arguments),this.pages=[],this.active=0}_select(t){this.dispatchEvent(new CustomEvent("hub-goto-page",{detail:{page:t},bubbles:!0,composed:!0}))}render(){return V`
      <nav>
        ${this.pages.map((t,e)=>{const i=function(t){const e=we[t];return e?{id:t,...e}:{id:t,label:t.charAt(0).toUpperCase()+t.slice(1),icon:"",tone:"neutral"}}(t),a=e===this.active,r=Rt[i.icon];return V`
            <button
    ...
    `],t([gt({attribute:!1})],$e.prototype,"pages",void 0),t([gt({type:Number})],$e.prototype,"active",void 0),customElements.define("hub-nav-bar",$e);const ke=["hem","ljus","media","energi","kcal"],Ce={hem:"Hem",ljus:"Ljus",media:"Media",energi:"Energi",kcal:"Kcal"};const Ee=["auto","dag","natt"];let Se=0;class Ae extends vt{constructor(){super(...arguments),this.theme="natt",this._page=0,this._dragX=0,this._openRoom=null,this._override=function(){const t=localStorage.getItem(Nt);return"natt"===t||"dag"===t?t:"auto"}(),this._pointerActive=!1,this._dragging=!1,this._startX=0,this._startY=0,this._lastX=0,this._lastT=0,this._velocity=0,this._onRoomOpen=t=>{const e=t.detail?.roomId;this._openRoom=this._cfg?.rooms?.find(t=>t.id===e)??null},this._onGotoPage=t=>{const e=t.detail?.page;e&&this.goToPage(e)},this._onPopupClose=()=>{this._openRoom=null},this._onAnyInteraction=()=>{this._resetIdle()},this._onPointerDown=t=>{this._pointerActive=!0,this._dragging=!1,this._startX=t.clientX,this._startY=t.clientY,this._lastX=t.clientX,this._lastT=t.timeStamp,this._velocity=0,this._dragX=0},this._onPointerMove=t=>{if(!this._pointerActive)return;const e=t.clientX-this._startX,i=t.clientY-this._startY;if(!this._dragging){if(!zt(e)&&!zt(i))return;if(!function(t,e){return Math.abs(t)>Math.abs(e)}(e,i))return void(this._pointerActive=!1);this._dragging=!0,t.currentTarget.setPointerCapture?.(t.pointerId),this._lastX=t.clientX,this._lastT=t.timeStamp}const a=t.timeStamp-this._lastT;a>0&&(this._velocity=(t.clientX-this._lastX)/a),this._lastX=t.clientX,this._lastT=t.timeStamp,this._dragX=e},this._onPointerUp=t=>{if(!this._pointerActive)return;const e=this._dragging;if(this._pointerActive=!1,this._dragging=!1,e){t.currentTarget.releasePointerCapture?.(t.pointerId);const e=this.clientWidth||window.innerWidth;this._page=function(t,e,i,a,r){const s=.2*e,n=Math.abs(i)>.5;let o=a;return t<-s||n&&i<-.5?o=a+1:(t>s||n&&i>.5)&&(o=a-1),Math.max(0,Math.min(r-1,o))}(this._dragX,e,this._velocity,this._page,this._pages.length),Se=this._page}this._dragX=0,this._velocity=0}}setConfig(t){super.setConfig(t)}get _cfg(){return this._config}get _pages(){return this._cfg?.pages??ke}connectedCallback(){super.connectedCallback(),function(){if(document.getElementById("glass-hub-fonts"))return;const t=document.createElement("style");t.id="glass-hub-fonts",t.textContent="\n@font-face{font-family:'Outfit';src:url('/local/glass-cards/fonts/outfit-variable.woff2') format('woff2-variations');font-weight:100 900;font-display:swap;}\n@font-face{font-family:'Inter';src:url('/local/glass-cards/fonts/inter-variable.woff2') format('woff2-variations');font-weight:100 900;font-display:swap;}\n",document.head.appendChild(t)}(),this._applyTheme(),this._page=Se,this._resetIdle(),this._startKioskDrawerShim(),this.addEventListener("pointerdown",this._onAnyInteraction),this.addEventListener("hub-room-open",this._onRoomOpen),this.addEventListener("hub-goto-page",this._onGotoPage),this.addEventListener("hub-popup-close",this._onPopupClose)}disconnectedCallback(){super.disconnectedCallback(),this._clearIdle(),void 0!==this._kioskTimer&&(clearInterval(this._kioskTimer),this._kioskTimer=void 0),this.removeEventListener("pointerdown",this._onAnyInteraction),this.removeEventListener("hub-room-open",this._onRoomOpen),this.removeEventListener("hub-goto-page",this._onGotoPage),this.removeEventListener("hub-popup-close",this._onPopupClose)}willUpdate(t){t.has("hass")&&this._applyTheme()}goToPage(t){const e=this._pages.indexOf(t);e>=0&&(this._page=e,Se=e,this._dragX=0)}_applyTheme(){const t=this.hass?.states["sun.sun"]?.attributes?.elevation,e="number"==typeof t?t:null;this.theme=function(t,e,i=4){return"auto"!==e?e:null===t?"natt":t>i?"dag":"natt"}(e,this._override,this._cfg?.day_elevation??4)}_cycleTheme(){const t=Ee.indexOf(this._override);this._override=Ee[(t+1)%Ee.length],function(t){localStorage.setItem(Nt,t)}(this._override),this._applyTheme()}_resetIdle(){this._clearIdle();const t=this._cfg?.idle_return_s??120;this._idleTimer=window.setTimeout(()=>{0!==this._page&&this.goToPage(this._pages[0])},1e3*t)}_clearIdle(){void 0!==this._idleTimer&&(clearTimeout(this._idleTimer),this._idleTimer=void 0)}_startKioskDrawerShim(){if(!new URLSearchParams(location.search).has("kiosk"))return;const t=Date.now(),e=()=>{const t=document.querySelector("home-assistant")?.shadowRoot?.querySelector("home-assistant-main");if(!t)return!1;t.style.setProperty("--mdc-drawer-width","0px");const e=t.shadowRoot?.querySelector("ha-drawer");return e?.style.setProperty("--mdc-drawer-width","0px"),!0};e()||(this._kioskTimer=window.setInterval(()=>{(e()||Date.now()-t>5e3)&&(clearInterval(this._kioskTimer),this._kioskTimer=void 0)},250))}_themeGlyph(){return"auto"===this._override?V`<span class="glyph-auto">A</span>`:"dag"===this._override?X`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"
                    ...
                    ></hub-lights-page>`:"energi"===t?V`<hub-energy-page
                      ...
                      ></hub-energy-page>`:"media"===t?V`<hub-media-page
                        ...
                        ></hub-media-page>`:"kcal"===t?V`<hub-kcal-page
                            .hass=${this.hass}
                            .config=${this._cfg}
                          ></hub-kcal-page>`:V`<h1 class="page-placeholder">${function(t){return Ce[t]??t.charAt(0).toUpperCase()+t.slice(1)}(t)}</h1>`}
            </section>
          `)}
      </div>
      ...
      <hub-nav-bar .pages=${t} .active=${this._page}></hub-nav-bar>
