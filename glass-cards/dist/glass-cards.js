...
`,Pt="glass-hub-theme";const Nt="glass-hub-weather-bg";function zt(){return"off"!==localStorage.getItem(Nt)}function Ft(t){localStorage.setItem(Nt,t?"on":"off")}let Dt=null;function jt(){return Dt}function Bt(t,e=8){return Math.abs(t)>e}const Lt=t=>q`
...
`,Ot={lamp:Lt(q`
  ...
  <path d="M8 18v.01M12 18v.01M16 18v.01M10 21v.01M14 21v.01" stroke-width="2.6"></path>
    ...
    `],t([gt({attribute:!1})],Ee.prototype,"config",void 0),customElements.define("hub-vacuum-card",Ee);class Me extends vt{constructor(){super(...arguments),this._items=null,this._lastCount="",this._fetchSeq=0,this._open=()=>{this.dispatchEvent(new CustomEvent("hub-todo-open",{bubbles:!0,composed:!0}))}}updated(t){super.updated(t);const e=this.config?.todo_entity;if(!e||!this.hass)return;const i=this.getEntity(e)?.state??"";i!==this._lastCount&&(this._lastCount=i,this._refresh())}async _refresh(){if(!this.hass||!this.config?.todo_entity)return;const t=++this._fetchSeq,e=await Se(this.hass,this.config.todo_entity);t===this._fetchSeq&&(this._items=e)}_complete(t,e){t.stopPropagation(),this.config.todo_entity&&this.callService("todo","update_item",{item:e.uid,status:"completed"},this.config.todo_entity)}render(){if(!this.hass||!this.config?.todo_entity)return V``;const{open:t}=Ce(this._items);return V`
      <div class="card" role="button" tabindex="0" aria-label="Visa att göra-listan" @click=${this._open}>
        ...
        ${0===t.length?V`<span class="empty">Inget att göra</span>`:t.slice(0,4).map(t=>V`
              ...
              `)}
        ${t.length>4?V`<span class="more">+${t.length-4} till</span>`:W}
      </div>
    `}}Me.styles=[Tt,o`
      :host { display: block; height: 100%; }
      .card {
    ...
    `],t([gt({attribute:!1})],De.prototype,"todayEntity",void 0),customElements.define("hub-kcal-ring",De);const je={frukost:"Frukost",lunch:"Lunch",middag:"Middag",mellis:"Mellis"},Be=["frukost","lunch","middag","mellis"],Le={gymdag:"G",vilodag:"V",flexdag:"F"};const Oe=/^\d{4}-\d{2}-\d{2}$/;function Ie(t){if(!t||"object"!=typeof t)return null;const e=t;if("frukost"!==(i=e.slot)&&"lunch"!==i&&"middag"!==i&&"mellis"!==i||"string"!=typeof e.name||""===e.name)return null;var i;const a=t=>"number"==typeof t&&Number.isFinite(t)?t:0;return{slot:e.slot,name:e.name,kcal:a(e.kcal),protein:a(e.protein),fat:a(e.fat),carbs:a(e.carbs),logged:!0===e.logged}}function Re(t){if(!t||"object"!=typeof t)return null;const e=t;if("string"!=typeof e.date||!Oe.test(e.date))return null;const i=Array.isArray(e.meals)?e.meals.map(Ie).filter(t=>null!==t):[];return{date:e.date,weekday:"string"==typeof e.weekday?e.weekday:"",day_type:"string"==typeof e.day_type?e.day_type:"vilodag",confirmed:!0===e.confirmed,meals:i,total_kcal:"number"==typeof e.total_kcal?e.total_kcal:0,target_kcal:"number"==typeof e.target_kcal?e.target_kcal:0,protein_ok:!0===e.protein_ok,kcal_ok:!1!==e.kcal_ok}}function He(t){if(!t)return null;const{week_start:e,today:i,days:a}=t;if("string"!=typeof e||!Oe.test(e))return null;if(!Array.isArray(a))return null;const s=a.map(Re).filter(t=>null!==t);return 0===s.length?null:{weekStart:e,today:"string"==typeof i&&Oe.test(i)?i:e,confirmedDays:s.filter(t=>t.confirmed).length,days:s}}function Ue(t){const e=t=>Be.flatMap(e=>t.meals.filter(t=>t.slot===e&&!t.logged)),i=t.days.find(e=>e.date===t.today);if(i){const t=e(i);if(t.length>0)return{dayLabel:"Idag",day:i,meals:t}}const a=t.days.find(e=>e.date===function(t,e){const[i,a,s]=t.split("-").map(Number);return new Date(Date.UTC(i,a-1,s+e)).toISOString().slice(0,10)}(t.today,1));if(a){const t=e(a);if(t.length>0)return{dayLabel:"Imorgon",day:a,meals:t}}return null}const Ve=new Intl.NumberFormat("sv-SE");class qe extends vt{_model(){if(!this.plannerEntity)return null;const t=this.getEntity(this.plannerEntity);return t&&"unavailable"!==t.state&&"unknown"!==t.state?He(t.attributes):null}_open(){this.dispatchEvent(new CustomEvent("hub-goto-page",{detail:{page:"vecka"},bubbles:!0,composed:!0}))}render(){if(!this.hass||!this.plannerEntity)return W;const t=this._model(),e=t?Ue(t):null;return V`
      <div class="card${e?"":" empty"}" @click=${this._open}>
        ...
        ${e?V`
              ...
              <div class="meals">
                ${e.meals.map(t=>V`
                    <div class="meal">
                      <span class="slot">${je[t.slot]}</span>
    ...
    `}}function Xe(t){const e=Date.parse(t.expected??t.scheduled??"");return Number.isNaN(e)?Number.POSITIVE_INFINITY:e}function We(t,e,i){if(!Array.isArray(t))return[];const a=i?new RegExp(i,"i"):null;return t.filter(t=>t?.line?.designation===e).filter(t=>!(a&&t.destination&&a.test(t.destination))).sort((t,e)=>Xe(t)-Xe(e))}qe.styles=[Tt,o`
      :host {
        display: block;
        height: 100%;
      }
    ...
    `],t([gt({attribute:!1})],qe.prototype,"plannerEntity",void 0),customElements.define("hub-meal-card",qe);function Ge(t){if(!Array.isArray(t))return[];const e=new Map;for(const i of t){if(!i||"object"!=typeof i)continue;const t=i;if("string"!=typeof t.header||0===t.header.length)continue;const a="number"==typeof t.priority?t.priority:0,s=Array.isArray(t.lines)?t.lines.map(t=>t&&"object"==typeof t?t.designation:null).filter(t=>"string"==typeof t&&t.length>0):[],r="string"==typeof t.details&&t.details.length>0?t.details:void 0,o="string"==typeof t.scope&&t.scope.length>0?t.scope:void 0,n=e.get(t.header);if(n){for(const t of s)n.badges.add(t);n.priority=Math.max(n.priority,a),!n.details&&r&&(n.details=r),!n.scope&&o&&(n.scope=o)}else e.set(t.header,{badges:new Set(s),priority:a,details:r,scope:o})}return[...e.entries()].sort((t,e)=>e[1].priority-t[1].priority).slice(0,5).map(([t,e])=>({badges:[...e.badges].sort(),header:t,...void 0!==e.details?{details:e.details}:{},...void 0!==e.scope?{scope:e.scope}:{}}))}const Ye=new Set(["unavailable","unknown",""]);function Ke(t){if(!t||Ye.has(t))return null;const e=new Date(t);if(Number.isNaN(e.getTime()))return null;return`${String(e.getHours()).padStart(2,"0")}:${String(e.getMinutes()).padStart(2,"0")}`}class Ze extends vt{constructor(){super(...arguments),this._open=()=>{this.dispatchEvent(new CustomEvent("hub-transit-open",{bubbles:!0,composed:!0}))}}_pendeltag(){const t=this.config.transit?.pendeltag;if(!t)return V`<span class="sub dim">–</span>`;const e=this.getEntity(t.next_entity),i=Ke(e?.state);if(!i)return V`<span class="sub dim">–</span>`;const a=this.getEntity(t.count_entity),s=a&&!Number.isNaN(Number(a.state))?Number(a.state):null;return V`<span class="sub">Nästa ${i}${null===s?"":` · ${s} ${1===s?"avgång":"avgångar"}`}</span>`}_bus(){const t=this.config.transit?.bus;if(!t)return V`<span class="sub dim">Inga avgångar idag</span>`;const e=this.getEntity(t.entity),i=We(e?.attributes.departures??[],t.line,t.exclude_destination).slice(0,3);return 0===i.length?V`<span class="sub dim">Inga avgångar idag</span>`:V`<span class="sub"
      >${i.map((t,e)=>V`${e>0?V`<span class="sep">·</span>`:""}<span
            class="dep ${t.state&&"EXPECTED"!==t.state?"delayed":""}"
            >${t.display??"–"}</span
          >`)}</span
    >`}_shaped(){const t=this.config.disturbances_entity?this.getEntity(this.config.disturbances_entity):void 0;return t&&"unavailable"!==t.state&&"unknown"!==t.state?Ge(t.attributes.deviations):[]}_alerts(t){if(0===t.length)return W;if(1===t.length){const e=t[0];return V`<div class="alerts">
        <div class="alert">
      ...
      <button class="card" aria-label=${null===e?"Elpris, öppna energisidan":`Elpris ${e} öre just nu${r?`, ${ni[a]}`:""}, öppna energisidan`} @click=${this._open}>
        <div class="head">
          <div class="lead">
            ...
            ${r?V`<span class="level ${s}">· ${ni[a]}</span>`:W}
          </div>
          ${n}
        </div>
  ...
  `,t([gt({attribute:!1})],Ci.prototype,"points",void 0),t([gt()],Ci.prototype,"stroke",void 0),t([gt({type:Number})],Ci.prototype,"width",void 0),t([gt({type:Number})],Ci.prototype,"height",void 0),customElements.define("hub-sparkline",Ci);const Si=new Intl.NumberFormat("sv-SE"),Mi=new Intl.NumberFormat("sv-SE",{minimumFractionDigits:1,maximumFractionDigits:1}),Ai=new Intl.NumberFormat("sv-SE",{maximumFractionDigits:1}),Ti=new Intl.DateTimeFormat("sv-SE",{day:"numeric",month:"short",timeZone:"UTC"}),Pi=new Intl.DateTimeFormat("sv-SE",{weekday:"long",day:"numeric",month:"long",timeZone:"UTC"});function Ni(t){if(!t)return"";const e=new Date(`${t}T00:00:00Z`);return Number.isNaN(e.getTime())?"":Ti.format(e).replace(/\.$/,"")}class zi extends vt{_meals(t){const e=t.attributes.meals;return Array.isArray(e)?e.filter(t=>!!t&&"object"==typeof t).map(t=>({name:"string"==typeof t.name?t.name:"",kcal:"number"==typeof t.kcal?t.kcal:Number(t.kcal)||0})).filter(t=>t.name):[]}_num(t){return"number"==typeof t?t:NaN}_offline(){return V`
    ...
    `}_weightCard(){const t=this.config.kcal?.forecast_entity,e=t?this.getEntity(t):void 0,i=e?Number(e.state):NaN;if(!e||"unavailable"===e.state||"unknown"===e.state||Number.isNaN(i))return V`
      ...
      <section class="card">
        ...
        ${n?V`<span class="w-delta">${n}</span>`:W}
      ...
      <div class="page">
        ...
        <div class="grid">
          <section class="card">
            ...
            ${n?V`<div class="kc-remain">${n}</div>`:W}
      ...
      <div class="scrim" @click=${()=>this._openDate=null}>
        <div class="popup" @click=${t=>t.stopPropagation()}>
          ...
          ${e.meals.map(t=>V`
              <div class="pm">
                <div>
                  <span class="pm-slot">${je[t.slot]}${t.logged?" · loggad":""}</span>
    ...
    `}_dayCard(t,e){const i=Be.filter(e=>t.meals.some(t=>t.slot===e));return V`
      ...
      >
        ...
        <div class="slots">
          ...
          ${i.map(e=>V`
              <div>
                <span class="slot-label">${je[e]}</span>
    ...
    `:V`<div class="page"><div class="offline">Vecka · offline</div></div>`}}ji.styles=[Tt,o`
      :host {
        display: block;
        height: 100%;
...
`;class Li extends vt{constructor(){super(...arguments),this.room=null,this._onScrim=t=>{t.target===t.currentTarget&&this._close()}}_close(){this.dispatchEvent(new CustomEvent("hub-popup-close",{bubbles:!0,composed:!0}))}_activateScene(t){this.callService("scene","turn_on",void 0,t)}render(){if(!this.room||!this.hass)return V``;const t=this.room;return V`
    ...
    `],t([gt({attribute:!1})],Li.prototype,"room",void 0),customElements.define("hub-room-popup",Li);const Oi=q`
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round">
    <path d="M6 6l12 12M18 6L6 18"></path>
  </svg>
`;class Ii extends vt{constructor(){super(...arguments),this.entity="",this.name="",this._onScrim=t=>{t.target===t.currentTarget&&this._close()}}_close(){this.dispatchEvent(new CustomEvent("hub-popup-close",{bubbles:!0,composed:!0}))}render(){return this.entity&&this.hass?V`
      <div class="scrim" @click=${this._onScrim}>
    ...
    `],t([gt()],Ii.prototype,"entity",void 0),t([gt()],Ii.prototype,"name",void 0),customElements.define("hub-light-popup",Ii);const Ri=q`
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round">
    <path d="M6 6l12 12M18 6L6 18"></path>
  </svg>
`,Hi=new Set(["EXPECTED","ATSTOP"]);class Ui extends vt{constructor(){super(...arguments),this._onScrim=t=>{t.target===t.currentTarget&&this._close()}}_close(){this.dispatchEvent(new CustomEvent("hub-popup-close",{bubbles:!0,composed:!0}))}_departures(t,e,i){if(!t)return[];const a=this.getEntity(t);return We(a?.attributes.departures??[],e,i).slice(0,6)}_depRow(t){const e=function(t){return"string"==typeof t.state&&t.state.length>0&&!Hi.has(t.state)}(t),i=Ke(t.expected??t.scheduled)??"–";return V`
      <div class="dep-row">
    ...
    `}render(){if(!this.hass||!this.config)return V``;const t=this.config,e=this._departures(t.departures?.list_entity,"43",""),i=t.transit?.bus,a=i?this._departures(i.entity,i.line,i.exclude_destination):[],s=t.disturbances_entity?this.getEntity(t.disturbances_entity):void 0,r=s&&"unavailable"!==s.state&&"unknown"!==s.state?Ge(s.attributes.deviations):[];return V`
      <div class="scrim" @click=${this._onScrim}>
...
`,qi=new Intl.DateTimeFormat("sv-SE",{weekday:"short"});class Xi extends vt{constructor(){super(...arguments),this._loc=0,this._hours=[],this._days=[],this._bgOn=zt(),this._loadedFor="",this._onScrim=t=>{t.target===t.currentTarget&&this._close()}}get _locations(){const t=this.config;return t?.weather_locations?.length?t.weather_locations:t?.weather_entity?[{entity:t.weather_entity,name:"Hem"}]:[]}updated(t){const e=this._locations[this._loc]?.entity;e&&this.hass&&(t.has("hass")||t.has("config"))&&this._loadedFor!==e&&this._load(e)}async _load(t){this._loadedFor=t;const[e,i]=await Promise.all([xe(this.hass,t,"hourly"),xe(this.hass,t,"daily")]);this._loadedFor===t&&(this._hours=e?Xt(e):[],this._days=i?Wt(i):[])}_pickLoc(t){if(t===this._loc)return;this._loc=t,this._hours=[],this._days=[];const e=this._locations[t]?.entity;e&&this._load(e)}_close(){this.dispatchEvent(new CustomEvent("hub-popup-close",{bubbles:!0,composed:!0}))}_toggleBg(){this._bgOn=!this._bgOn,Ft(this._bgOn),this.dispatchEvent(new CustomEvent("hub-weather-bg-toggle",{detail:{on:this._bgOn},bubbles:!0,composed:!0}))}get _isNight(){return"below_horizon"===this.hass?.states["sun.sun"]?.state}_hero(){const t=this.getEntity(this._locations[this._loc]?.entity??"");if(!t)return W;const e=t.attributes.temperature,i=t.attributes.apparent_temperature,a=t.attributes.wind_speed,s=t.attributes.wind_speed_unit??"km/h";return V`
    ...
    `],t([gt({attribute:!1})],Xi.prototype,"config",void 0),t([bt()],Xi.prototype,"_loc",void 0),t([bt()],Xi.prototype,"_hours",void 0),t([bt()],Xi.prototype,"_days",void 0),t([bt()],Xi.prototype,"_bgOn",void 0),customElements.define("hub-weather-popup",Xi);const Wi=o`
  :host {
    position: absolute;
    inset: 0;
    z-index: 40;
...
`;class Gi extends vt{constructor(){super(...arguments),this._onScrim=t=>{t.target===t.currentTarget&&this._close()},this._allOff=()=>{const t=[...new Set((this.config.rooms??[]).flatMap(t=>t.lights.map(t=>t.entity)))];this.hass?.callService("light","turn_off",{},{entity_id:t})}}_close(){this.dispatchEvent(new CustomEvent("hub-popup-close",{bubbles:!0,composed:!0}))}_scene(t){this.callService("scene","turn_on",void 0,t)}render(){if(!this.hass||!this.config)return V``;const t=this.config.rooms??[];return V`
    ...
    `],t([gt({attribute:!1})],Yi.prototype,"config",void 0),customElements.define("hub-vacuum-popup",Yi);class Ki extends vt{constructor(){super(...arguments),this._items=null,this._lastCount="",this._fetchSeq=0,this._onScrim=t=>{t.target===t.currentTarget&&this._close()}}updated(t){super.updated(t);const e=this.config?.todo_entity;if(!e||!this.hass)return;const i=this.getEntity(e)?.state??"";i!==this._lastCount&&(this._lastCount=i,this._refresh())}async _refresh(){if(!this.hass||!this.config?.todo_entity)return;const t=++this._fetchSeq,e=await Se(this.hass,this.config.todo_entity);t===this._fetchSeq&&(this._items=e)}_close(){this.dispatchEvent(new CustomEvent("hub-popup-close",{bubbles:!0,composed:!0}))}async _add(){const t=this.shadowRoot?.querySelector("input"),e=t?.value.trim();e&&this.config.todo_entity&&(this.callService("todo","add_item",{item:e},this.config.todo_entity),t&&(t.value=""))}_toggle(t){if(!this.config.todo_entity)return;const e="completed"===t.status?"needs_action":"completed";this.callService("todo","update_item",{item:t.uid,status:e},this.config.todo_entity),window.setTimeout(()=>{this._refresh()},400)}_clearDone(){this.config.todo_entity&&(this.callService("todo","remove_completed_items",void 0,this.config.todo_entity),window.setTimeout(()=>{this._refresh()},400))}render(){if(!this.hass||!this.config?.todo_entity)return V``;const{open:t,done:e}=Ce(this._items),i=V`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round"><path d="M5 13l4 4L19 7"></path></svg>`;return V`
      <div class="scrim" @click=${this._onScrim}>
        <div class="card" role="dialog" aria-label="Att göra">
          ...
          ${[...t,...e].map(t=>V`
            ...
            `)}
          ${e.length?V`<button class="clear" @click=${()=>this._clearDone()}>Rensa klara (${e.length})</button>`:W}
        </div>
      </div>
    `}}Ki.styles=[Tt,Wi,o`
      .add {
    ...
    `],t([gt({attribute:!1})],Ji.prototype,"pages",void 0),t([gt({type:Number})],Ji.prototype,"active",void 0),customElements.define("hub-nav-bar",Ji);const Qi=["hem","ljus","media","energi","kcal","vecka"],ta={hem:"Hem",ljus:"Ljus",media:"Media",energi:"Energi",kcal:"Kcal",vecka:"Vecka"};const ea=["auto","dag","natt"];let ia=0;class aa extends vt{constructor(){super(...arguments),this.theme="natt",this.kiosk=new URLSearchParams(location.search).has("kiosk"),this._page=0,this._dragX=0,this._openRoom=null,this._openLight=null,this._openTransit=!1,this._openWeather=!1,this._openLights=!1,this._openVacuum=!1,this._openTodo=!1,this._weatherBgOn=zt(),this._override=function(){const t=localStorage.getItem(Pt);return"natt"===t||"dag"===t?t:"auto"}(),this._pointerActive=!1,this._dragging=!1,this._startX=0,this._startY=0,this._lastX=0,this._lastT=0,this._velocity=0,this._onRoomOpen=t=>{const e=t.detail?.roomId;this._openRoom=this._cfg?.rooms?.find(t=>t.id===e)??null},this._onLightOpen=t=>{const e=t.detail;this._openLight=e?.entity?{entity:e.entity,name:e.name??e.entity}:null},this._onGotoPage=t=>{const e=t.detail?.page;e&&this.goToPage(e)},this._onTransitOpen=()=>{this._openTransit=!0},this._onLightsOpen=()=>{this._openLights=!0},this._onVacuumOpen=()=>{this._openVacuum=!0},this._onTodoOpen=()=>{this._openTodo=!0},this._onWeatherOpen=()=>{this._openWeather=!0},this._onWeatherBgToggle=t=>{this._weatherBgOn=t.detail?.on??zt(),Ft(this._weatherBgOn)},this._onPopupClose=()=>{this._openRoom=null,this._openLight=null,this._openTransit=!1,this._openWeather=!1,this._openLights=!1,this._openVacuum=!1,this._openTodo=!1},this._onAnyInteraction=()=>{this._resetIdle()},this._onPointerDown=t=>{this._pointerActive=!0,this._dragging=!1,this._startX=t.clientX,this._startY=t.clientY,this._lastX=t.clientX,this._lastT=t.timeStamp,this._velocity=0,this._dragX=0},this._onPointerMove=t=>{if(!this._pointerActive)return;const e=t.clientX-this._startX,i=t.clientY-this._startY;if(!this._dragging){if(!Bt(e)&&!Bt(i))return;if(!function(t,e){return Math.abs(t)>Math.abs(e)}(e,i))return void(this._pointerActive=!1);this._dragging=!0,t.currentTarget.setPointerCapture?.(t.pointerId),this._lastX=t.clientX,this._lastT=t.timeStamp}const a=t.timeStamp-this._lastT;a>0&&(this._velocity=(t.clientX-this._lastX)/a),this._lastX=t.clientX,this._lastT=t.timeStamp,this._dragX=e},this._onPointerUp=t=>{if(!this._pointerActive)return;const e=this._dragging;if(this._pointerActive=!1,this._dragging=!1,e){t.currentTarget.releasePointerCapture?.(t.pointerId);const e=this.clientWidth||window.innerWidth;this._page=function(t,e,i,a,s){const r=.2*e,o=Math.abs(i)>.5;let n=a;return t<-r||o&&i<-.5?n=a+1:(t>r||o&&i>.5)&&(n=a-1),Math.max(0,Math.min(s-1,n))}(this._dragX,e,this._velocity,this._page,this._pages.length),ia=this._page}this._dragX=0,this._velocity=0}}setConfig(t){super.setConfig(t)}get _cfg(){return this._config}get _pages(){return this._cfg?.pages??Qi}connectedCallback(){super.connectedCallback(),function(){if(document.getElementById("glass-hub-fonts"))return;const t=document.createElement("style");t.id="glass-hub-fonts",t.textContent="\n@font-face{font-family:'Outfit';src:url('/local/glass-cards/fonts/outfit-variable.woff2') format('woff2-variations');font-weight:100 900;font-display:swap;}\n@font-face{font-family:'Inter';src:url('/local/glass-cards/fonts/inter-variable.woff2') format('woff2-variations');font-weight:100 900;font-display:swap;}\n",document.head.appendChild(t)}(),this._applyTheme(),this._page=ia,this._resetIdle(),this._startKioskDrawerShim(),function(){const t=new URLSearchParams(location.search).get("weather");t&&(Dt=t),window.__hubForceWeather=t=>{Dt=t,window.dispatchEvent(new CustomEvent("hub-weather-force"))}}(),this.addEventListener("pointerdown",this._onAnyInteraction),this.addEventListener("hub-room-open",this._onRoomOpen),this.addEventListener("hub-light-open",this._onLightOpen),this.addEventListener("hub-transit-open",this._onTransitOpen),this.addEventListener("hub-goto-page",this._onGotoPage),this.addEventListener("hub-popup-close",this._onPopupClose),this.addEventListener("hub-weather-open",this._onWeatherOpen),this.addEventListener("hub-lights-open",this._onLightsOpen),this.addEventListener("hub-vacuum-open",this._onVacuumOpen),this.addEventListener("hub-todo-open",this._onTodoOpen),this.addEventListener("hub-weather-bg-toggle",this._onWeatherBgToggle)}disconnectedCallback(){super.disconnectedCallback(),this._clearIdle(),void 0!==this._kioskTimer&&(clearInterval(this._kioskTimer),this._kioskTimer=void 0),this.removeEventListener("pointerdown",this._onAnyInteraction),this.removeEventListener("hub-room-open",this._onRoomOpen),this.removeEventListener("hub-light-open",this._onLightOpen),this.removeEventListener("hub-transit-open",this._onTransitOpen),this.removeEventListener("hub-goto-page",this._onGotoPage),this.removeEventListener("hub-popup-close",this._onPopupClose),this.removeEventListener("hub-weather-open",this._onWeatherOpen),this.removeEventListener("hub-lights-open",this._onLightsOpen),this.removeEventListener("hub-vacuum-open",this._onVacuumOpen),this.removeEventListener("hub-todo-open",this._onTodoOpen),this.removeEventListener("hub-weather-bg-toggle",this._onWeatherBgToggle)}willUpdate(t){t.has("hass")&&this._applyTheme()}goToPage(t){const e=this._pages.indexOf(t);e>=0&&(this._page=e,ia=e,this._dragX=0)}_applyTheme(){const t=this.hass?.states["sun.sun"]?.attributes?.elevation,e="number"==typeof t?t:null;this.theme=function(t,e,i=4){return"auto"!==e?e:null===t?"natt":t>i?"dag":"natt"}(e,this._override,this._cfg?.day_elevation??4)}_cycleTheme(){const t=ea.indexOf(this._override);this._override=ea[(t+1)%ea.length],function(t){localStorage.setItem(Pt,t)}(this._override),this._applyTheme()}_toggleKiosk(){const t=new URLSearchParams(location.search);t.has("kiosk")?t.delete("kiosk"):t.set("kiosk","true");const e=t.toString();location.assign(location.pathname+(e?`?${e}`:""))}_resetIdle(){this._clearIdle();const t=this._cfg?.idle_return_s??120;this._idleTimer=window.setTimeout(()=>{0!==this._page&&this.goToPage(this._pages[0])},1e3*t)}_clearIdle(){void 0!==this._idleTimer&&(clearTimeout(this._idleTimer),this._idleTimer=void 0)}_startKioskDrawerShim(){if(!new URLSearchParams(location.search).has("kiosk"))return;const t=Date.now(),e=()=>{const t=document.querySelector("home-assistant")?.shadowRoot?.querySelector("home-assistant-main");if(!t)return!1;t.style.setProperty("--mdc-drawer-width","0px");const e=t.shadowRoot?.querySelector("ha-drawer");return e?.style.setProperty("--mdc-drawer-width","0px"),!0};e()||(this._kioskTimer=window.setInterval(()=>{(e()||Date.now()-t>5e3)&&(clearInterval(this._kioskTimer),this._kioskTimer=void 0)},250))}_themeGlyph(){return"auto"===this._override?V`<span class="glyph-auto">A</span>`:"dag"===this._override?q`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"
      ...
      ${this._openTodo?V`<hub-todo-popup .hass=${this.hass} .config=${this._cfg}></hub-todo-popup>`:W}
    `}}aa.styles=[Tt,o`
      :host {
        position: absolute;
        inset: 0;
