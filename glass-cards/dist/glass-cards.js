...
`;class ia extends mt{constructor(){super(...arguments),this._onScrim=t=>{t.target===t.currentTarget&&this._close()},this._allOff=()=>{const t=[...new Set((this.config.rooms??[]).flatMap(t=>t.lights.map(t=>t.entity)))];this.hass?.callService("light","turn_off",{},{entity_id:t})}}_close(){this.dispatchEvent(new CustomEvent("hub-popup-close",{bubbles:!0,composed:!0}))}_scene(t){this.callService("scene","turn_on",void 0,t)}render(){if(!this.hass||!this.config)return U``;const t=this.config.rooms??[];return U`
    ...
    `],t([gt({attribute:!1})],ia.prototype,"config",void 0),customElements.define("hub-lights-modal",ia);class aa extends mt{constructor(){super(...arguments),this._onScrim=t=>{t.target===t.currentTarget&&this._close()}}_close(){this.dispatchEvent(new CustomEvent("hub-popup-close",{bubbles:!0,composed:!0}))}_press(t){this.callService("button","press",void 0,t)}_vac(t){this.config.vacuum_entity&&this.callService("vacuum",t,void 0,this.config.vacuum_entity)}_selectOption(t,e){this.callService("select","select_option",{option:e},t)}_selectChips(t){if(!t)return X;const e=this.getEntity(t),i=e?.attributes.options??[];return i.length?U`<div class="chips">
      ${i.map(i=>U`
          <button class="chip ${e?.state===i?"sel":""}" @click=${()=>this._selectOption(t,i)}>
            ${i}
          </button>
        `)}
    </div>`:X}render(){if(!this.hass||!this.config)return U``;const t=this.config.vacuum_controls,e=this.config.vacuum_entity?this.getEntity(this.config.vacuum_entity):void 0,i=e?.state??"unknown",a=t?.status_entity?this.getEntity(t.status_entity)?.state:i,s=t?.battery_entity?this.getEntity(t.battery_entity)?.state:void 0,r=t?.current_room_entity?this.getEntity(t.current_room_entity)?.state:void 0,n="cleaning"===i||"returning"===i,o="paused"===i;return U`
      <div class="scrim" @click=${this._onScrim}>
        <div class="card" role="dialog" aria-label="Roborock">
          ...
          <div class="status">
            <span class="state">${a??"–"}${n&&r?` · ${r}`:""}</span>
            ${s?U`<span class="batt">${s}%</span>`:X}
          </div>
          <div class="actions">
            ${n||o?U`
                  <button class="act" @click=${()=>this._vac(o?"start":"pause")}>
                    ${o?"Fortsätt":"Pausa"}
                  </button>
          ...
          ${t?.consumables?.length?U`<div class="sect">Förbrukning</div>
                <div class="cons">
                  ${t.consumables.map(t=>{const e=this.getEntity(t.entity),i=e?.attributes.unit_of_measurement??"";return U`<div class="cons-row">
    ...
    `],t([gt({attribute:!1})],la.prototype,"config",void 0),t([bt()],la.prototype,"_events",void 0),t([bt()],la.prototype,"_creating",void 0),t([bt()],la.prototype,"_saving",void 0),t([bt()],la.prototype,"_durMin",void 0),t([bt()],la.prototype,"_saveError",void 0),customElements.define("hub-calendar-popup",la);const ca={hem:{label:"Hem",icon:"home",tone:"neutral"},ljus:{label:"Ljus",icon:"lamp",tone:"amber"},media:{label:"Media",icon:"note",tone:"teal"},energi:{label:"Energi",icon:"bolt",tone:"green"},kcal:{label:"Kcal",icon:"ring",tone:"lavender"},vecka:{label:"Vecka",icon:"calendar",tone:"lavender"}};class ha extends ct{constructor(){super(...arguments),this.pages=[],this.active=0}_select(t){this.dispatchEvent(new CustomEvent("hub-goto-page",{detail:{page:t},bubbles:!0,composed:!0}))}render(){return U`
      <nav>
        <div class="rail"></div>
        <div class="items">
          ${this.pages.map((t,e)=>{const i=function(t){const e=ca[t];return e?{id:t,...e}:{id:t,label:t.charAt(0).toUpperCase()+t.slice(1),icon:"",tone:"neutral"}}(t),a=e===this.active,s=Bt[i.icon];return U`
              <button
                      ...
                      ></hub-energy-page>`:"media"===e?U`<hub-media-page
                        ...
                        ></hub-media-page>`:"kcal"===e?U`<hub-kcal-page
                          ...
                          ></hub-kcal-page>`:"vecka"===e?U`<hub-planner-page
                              .hass=${this.hass}
                              .config=${this._cfg}
                            ></hub-planner-page>`:U`<h1 class="page-placeholder">${function(t){return pa[t]??t.charAt(0).toUpperCase()+t.slice(1)}(e)}</h1>`}
            </section>
          `)}
      </div>
