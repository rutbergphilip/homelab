        ...
        ${0===i.length?V`<div class="empty-state">Inga avgångar</div>`:V`
              <div class="departure-list">
                ${i.map(t=>V`
                    ...
                    ${t.deviations?.length?t.deviations.filter(t=>t.message).map(t=>V`<div class="deviation">${t.message}</div>`):W}
                  `)}
              </div>
            `}
      </div>
...
`,Pt="glass-hub-theme";const Nt="glass-hub-weather-bg";function zt(){return"off"!==localStorage.getItem(Nt)}function Ft(t){localStorage.setItem(Nt,t?"on":"off")}let Dt=null;function Bt(){return Dt}function jt(t,e=8){return Math.abs(t)>e}const Ot=t=>X`
...
`,It={lamp:Ot(X`
  ...
  <path d="M8 18v.01M12 18v.01M16 18v.01M10 21v.01M14 21v.01" stroke-width="2.6"></path>
    ...
    `],t([gt({attribute:!1})],Pe.prototype,"todayEntity",void 0),customElements.define("hub-kcal-ring",Pe);const Ne={frukost:"Frukost",lunch:"Lunch",middag:"Middag",mellis:"Mellis"},ze=["frukost","lunch","middag","mellis"],Fe={gymdag:"G",vilodag:"V",flexdag:"F"};const De=/^\d{4}-\d{2}-\d{2}$/;function Be(t){if(!t||"object"!=typeof t)return null;const e=t;if("frukost"!==(i=e.slot)&&"lunch"!==i&&"middag"!==i&&"mellis"!==i||"string"!=typeof e.name||""===e.name)return null;var i;const a=t=>"number"==typeof t&&Number.isFinite(t)?t:0;return{slot:e.slot,name:e.name,kcal:a(e.kcal),protein:a(e.protein),fat:a(e.fat),carbs:a(e.carbs),logged:!0===e.logged}}function je(t){if(!t||"object"!=typeof t)return null;const e=t;if("string"!=typeof e.date||!De.test(e.date))return null;const i=Array.isArray(e.meals)?e.meals.map(Be).filter(t=>null!==t):[];return{date:e.date,weekday:"string"==typeof e.weekday?e.weekday:"",day_type:"string"==typeof e.day_type?e.day_type:"vilodag",confirmed:!0===e.confirmed,meals:i,total_kcal:"number"==typeof e.total_kcal?e.total_kcal:0,target_kcal:"number"==typeof e.target_kcal?e.target_kcal:0,protein_ok:!0===e.protein_ok,kcal_ok:!1!==e.kcal_ok}}function Oe(t){if(!t)return null;const{week_start:e,today:i,days:a}=t;if("string"!=typeof e||!De.test(e))return null;if(!Array.isArray(a))return null;const s=a.map(je).filter(t=>null!==t);return 0===s.length?null:{weekStart:e,today:"string"==typeof i&&De.test(i)?i:e,confirmedDays:s.filter(t=>t.confirmed).length,days:s}}function Ie(t){const e=t=>ze.flatMap(e=>t.meals.filter(t=>t.slot===e&&!t.logged)),i=t.days.find(e=>e.date===t.today);if(i){const t=e(i);if(t.length>0)return{dayLabel:"Idag",day:i,meals:t}}const a=t.days.find(e=>e.date===function(t,e){const[i,a,s]=t.split("-").map(Number);return new Date(Date.UTC(i,a-1,s+e)).toISOString().slice(0,10)}(t.today,1));if(a){const t=e(a);if(t.length>0)return{dayLabel:"Imorgon",day:a,meals:t}}return null}const Le=new Intl.NumberFormat("sv-SE");class Re extends mt{_model(){if(!this.plannerEntity)return null;const t=this.getEntity(this.plannerEntity);return t&&"unavailable"!==t.state&&"unknown"!==t.state?Oe(t.attributes):null}_open(){this.dispatchEvent(new CustomEvent("hub-goto-page",{detail:{page:"vecka"},bubbles:!0,composed:!0}))}render(){if(!this.hass||!this.plannerEntity)return W;const t=this._model(),e=t?Ie(t):null;return V`
      <div class="card${e?"":" empty"}" @click=${this._open}>
        <div class="head">
          <span class="eyebrow">Matsedel</span>
          ${t?V`<span class="count">${t.confirmedDays} / 7 ✓</span>`:W}
        </div>
        ${e?V`
              ...
              <div class="meals">
                ${e.meals.map(t=>V`
                    <div class="meal">
                      ...
                      <span class="kcal">${Le.format(t.kcal)}</span>
                    </div>
                  `)}
              </div>
    ...
    `],t([gt({attribute:!1})],We.prototype,"config",void 0),customElements.define("hub-transit-card",We);const qe=36e5,Ye=new Set(["unavailable","unknown","none",""]);function Ke(t,e,i){if(!Array.isArray(t))return[];const a=[];for(const s of t){if(!s||"object"!=typeof s)continue;const t=s,r="number"==typeof t.total?t.total:Number(t.total);if(!Number.isFinite(r)||"string"!=typeof t.startsAt)continue;const n=new Date(t.startsAt);if(Number.isNaN(n.getTime()))continue;const o="number"==typeof t.energy?t.energy:Number(t.energy),l=Number.isFinite(o)?100*o:null,h=100*r,c="spot"===e&&null!==l?l:h+("allin"===e?i:0);a.push({start:n,ore:c,totalOre:h,spotOre:l})}return a.sort((t,e)=>t.start.getTime()-e.start.getTime())}function Ze(t){if(t.length<3)return null;let e=1/0,i=-1;for(let a=0;a+3<=t.length;a++){let s=!0,r=t[a].ore;for(let e=a+1;e<a+3;e++){if(t[e].start.getTime()-t[e-1].start.getTime()!==qe){s=!1;break}r+=t[e].ore}s&&r<e&&(e=r,i=a)}return i<0?null:{start:t[i].start,end:new Date(t[i+3-1].start.getTime()+qe)}}function Je(t,e,i,a="allin",s=0){if(Ye.has(String(e??"").toLowerCase()))return{now:null,level:"normal",today:[],tomorrow:[],cheapestWindow:null};const r=Ke(t?.today,a,s),n=Ke(t?.tomorrow,a,s);if(0===r.length&&0===n.length)return{now:null,level:"normal",today:[],tomorrow:[],cheapestWindow:null};const o=[...r,...n].sort((t,e)=>t.start.getTime()-e.start.getTime()),l=i.getTime(),h=o.find(t=>t.start.getTime()<=l&&l<t.start.getTime()+qe)??null;let c="normal";if(h&&r.length){const t=r.reduce((t,e)=>t+e.ore,0)/r.length;if(t>0){const e=h.ore/t;e<.85?c="låg":e>1.15&&(c="hög")}}const d=o.filter(t=>t.start.getTime()+qe>l);return{now:h,level:c,today:r,tomorrow:n,cheapestWindow:Ze(d)}}function Qe(t){const e=[...t.today,...t.tomorrow];return e.length>0&&e.every(t=>null!==t.spotOre)}const ti="glass-hub-price-view";function ei(){try{return"spot"===localStorage.getItem(ti)?"spot":"allin"}catch{return"allin"}}function ii(t){return(t?.grid?.overforing_ore??0)+(t?.grid?.energiskatt_ore??0)}const ai={"låg":"lågt",normal:"normalt","hög":"högt"};class si extends mt{constructor(){super(...arguments),this._now=new Date,this._open=()=>{this.dispatchEvent(new CustomEvent("hub-goto-page",{detail:{page:"energi"},bubbles:!0,composed:!0}))}}connectedCallback(){super.connectedCallback(),this._interval=window.setInterval(()=>{this._now=new Date},6e4)}disconnectedCallback(){super.disconnectedCallback(),void 0!==this._interval&&(clearInterval(this._interval),this._interval=void 0)}_model(){const t=this.config.price_series_entity?this.getEntity(this.config.price_series_entity):void 0;if(!t)return null;const e=ei(),i=t.attributes,a=Je(i,t.state,this._now,e,"allin"===e?ii(this.config):0);return"spot"===e&&a.today.length&&a.today.some(t=>null===t.spotOre)?Je(i,t.state,this._now,"allin",ii(this.config)):a}_currentOre(t){if(t?.now)return Math.round(t.now.ore);const e=this.config.price_entity?this.getEntity(this.config.price_entity):void 0;return e&&!Number.isNaN(Number(e.state))?Math.round(100*Number(e.state)):null}_bars(t){const e=function(t,e){const i=[...t.today,...t.tomorrow].sort((t,e)=>t.start.getTime()-e.start.getTime()),a=e.getTime(),s=t.cheapestWindow,r=s?s.start.getTime():null,n=s?s.end.getTime():null;return i.filter(t=>t.start.getTime()+qe>a).slice(0,12).map(t=>{const e=t.start.getTime();return{start:t.start,ore:t.ore,current:e<=a&&a<e+qe,cheap:null!==r&&e>=r&&e<n}})}(t,this._now);if(0===e.length)return V`<div class="waiting">Väntar på prisdata</div>`;const i=e.map(t=>t.ore),a=Math.min(...i),s=Math.max(...i)-a;return V`<div class="bars">
      ...
      <button class="card" aria-label=${null===e?"Elpris, öppna energisidan":`Elpris ${e} öre just nu${r?`, ${ai[a]}`:""}, öppna energisidan`} @click=${this._open}>
        <div class="head">
          <div class="lead">
            ...
            ${r?V`<span class="level ${s}">· ${ai[a]}</span>`:W}
          </div>
          ${o}
        </div>
          ...
          <div class="chips">
            ${this._chips.map(t=>V`
                <hub-status-chip
                  ...
                  .tone=${t.tone}
                  ?active=${t.active}
                  @click=${t.goto?()=>this._gotoPage(t.goto):W}
                ></hub-status-chip>
              `)}
          </div>
        </div>
        ...
        <div class="header">
          ...
          <div class="actions">
            ${(t.scenes??[]).map(t=>V`
                ...
                >
                  ${It[t.icon]?V`<span class="ic">${It[t.icon]}</span>`:W}
                  <span>${t.name}</span>
                </button>
              `)}
            <button
      ...
      <div class="chart">
        <div class="plot" style="grid-template-columns:${a}">
          ${t.map((a,s)=>{if("divider"===a.kind)return V`<div class="divider"></div>`;const r=this._height(a.hour.ore,e,i),n=a.cls.startsWith("future")?`background:${this._tint(a.hour.ore,e,i)}`:"";return V`
              ...
              >
                ${this._detail===s?this._flyout(a.hour,s,t.length):W}
                ${a.label&&this._detail!==s?V`<span class="cell-label">${a.label}</span>`:W}
        ...
        ${X`
          ...
          >
            ...
            ${s?X`<polygon points="${r}" fill="url(#${this._gid})" stroke="none"></polygon>
                       <polyline points="${e}" vector-effect="non-scaling-stroke"></polyline>`:W}
          </svg>
        `}
        <span
          class="dot"
  ...
  `,t([gt({attribute:!1})],wi.prototype,"points",void 0),t([gt()],wi.prototype,"stroke",void 0),t([gt({type:Number})],wi.prototype,"width",void 0),t([gt({type:Number})],wi.prototype,"height",void 0),customElements.define("hub-sparkline",wi);const ki=new Intl.NumberFormat("sv-SE"),$i=new Intl.NumberFormat("sv-SE",{minimumFractionDigits:1,maximumFractionDigits:1}),Ei=new Intl.NumberFormat("sv-SE",{maximumFractionDigits:1}),Ci=new Intl.DateTimeFormat("sv-SE",{day:"numeric",month:"short",timeZone:"UTC"}),Si=new Intl.DateTimeFormat("sv-SE",{weekday:"long",day:"numeric",month:"long",timeZone:"UTC"});function Mi(t){if(!t)return"";const e=new Date(`${t}T00:00:00Z`);return Number.isNaN(e.getTime())?"":Ci.format(e).replace(/\.$/,"")}class Ai extends mt{_meals(t){const e=t.attributes.meals;return Array.isArray(e)?e.filter(t=>!!t&&"object"==typeof t).map(t=>({name:"string"==typeof t.name?t.name:"",kcal:"number"==typeof t.kcal?t.kcal:Number(t.kcal)||0})).filter(t=>t.name):[]}_num(t){return"number"==typeof t?t:NaN}_offline(){return V`
    ...
    `}_weightCard(){const t=this.config.kcal?.forecast_entity,e=t?this.getEntity(t):void 0,i=e?Number(e.state):NaN;if(!e||"unavailable"===e.state||"unknown"===e.state||Number.isNaN(i))return V`
      ...
      <section class="card">
        ...
        ${o?V`<span class="w-delta">${o}</span>`:W}
        ...
        <div class="forecast">
          ...
          ${d?V`<span class="fc-chip">i fas ✓</span>`:W}
        </div>
      </section>
    `}render(){if(!this.hass||!this.config)return V``;const t=this.config.kcal?.today_entity,e=t?this.getEntity(t):void 0,i=e?Number(e.state):NaN;if(!e||"unavailable"===e.state||"unknown"===e.state||Number.isNaN(i))return this._offline();const a=this._num(e.attributes.kcal_target),s=Te(i,a),r=Number.isFinite(a)&&a>0,n=r?a-i:NaN,o=r?n>0?`${ki.format(Math.round(n))} kcal kvar`:0===n?"Målet nått":`${ki.format(Math.round(-n))} över målet`:null,l=this._num(e.attributes.protein_g),h=this._num(e.attributes.protein_target_g),c=Number.isFinite(l)&&Number.isFinite(h)&&h>0,d=c?Math.max(0,Math.min(100,l/h*100)):0,p=this._meals(e),u=e.attributes.date,g="string"!=typeof u||Number.isNaN(new Date(`${u}T00:00:00Z`).getTime())?"":Si.format(new Date(`${u}T00:00:00Z`));return V`
      <div class="page">
        <div class="header">
          ...
          ${g?V`<span class="subtitle">${g}</span>`:W}
        </div>
        ...
        <div class="grid">
          <section class="card">
            ...
            ${o?V`<div class="kc-remain">${o}</div>`:W}
      ...
      <div class="scrim" @click=${()=>this._openDate=null}>
        <div class="popup" @click=${t=>t.stopPropagation()}>
          ...
          ${e.meals.map(t=>V`
            ...
            `)}
          ${0===e.meals.length?V`<div class="empty-day">Inget planerat.</div>`:W}
          <div class="popup-actions">
            ${e.confirmed?V`<span class="confirmed-note">Dagen är låst ✓</span>`:W}
    ...
    `}_dayCard(t,e){const i=ze.filter(e=>t.meals.some(t=>t.slot===e));return V`
      <button
      ...
      >
        <div class="day-head">
          ...
          ${t.confirmed?V`<span class="lock">✓</span>`:W}
          <span class="type-chip ${t.day_type}">${a=t.day_type,Fe[a]??"·"}</span>
        </div>
        <div class="slots">
          ${0===i.length?V`<span class="empty-day">—</span>`:W}
          ${i.map(e=>V`
              <div>
        ...
        <div class="day-foot">
          ${t.meals.length>0?V`${Ti.format(t.total_kcal)} / ${Ti.format(t.target_kcal)}
              ${t.kcal_ok&&t.protein_ok?W:V`<span class="warn"> ⚠</span>`}`:V`&nbsp;`}
        </div>
      </button>
    `;var a}render(){if(!this.hass||!this.config)return V``;const t=this._model();return t?V`
      ...
      ${this._openDate?this._dayPopup(t):W}
    ...
    `],t([gt({attribute:!1})],Ni.prototype,"config",void 0),t([bt()],Ni.prototype,"_openDate",void 0),t([bt()],Ni.prototype,"_confirming",void 0),customElements.define("hub-planner-page",Ni);const zi=X`
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round">
    <path d="M6 6l12 12M18 6L6 18"></path>
  </svg>
`;class Fi extends mt{constructor(){super(...arguments),this.room=null,this._onScrim=t=>{t.target===t.currentTarget&&this._close()}}_close(){this.dispatchEvent(new CustomEvent("hub-popup-close",{bubbles:!0,composed:!0}))}_activateScene(t){this.callService("scene","turn_on",void 0,t)}render(){if(!this.room||!this.hass)return V``;const t=this.room;return V`
    ...
    `],t([gt({attribute:!1})],Fi.prototype,"room",void 0),customElements.define("hub-room-popup",Fi);const Di=X`
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round">
    <path d="M6 6l12 12M18 6L6 18"></path>
  </svg>
...
`,Oi=new Set(["EXPECTED","ATSTOP"]);class Ii extends mt{constructor(){super(...arguments),this._onScrim=t=>{t.target===t.currentTarget&&this._close()}}_close(){this.dispatchEvent(new CustomEvent("hub-popup-close",{bubbles:!0,composed:!0}))}_departures(t,e,i){if(!t)return[];const a=this.getEntity(t);return Ue(a?.attributes.departures??[],e,i).slice(0,6)}_depRow(t){const e=function(t){return"string"==typeof t.state&&t.state.length>0&&!Oi.has(t.state)}(t),i=Ge(t.expected??t.scheduled)??"–";return V`
    ...
    `}_storSection(t){return 0===t.length?W:V`
      <div class="section">
        ...
        ${t.map(t=>V`
            <div class="stor">
              ...
              ${t.details?V`<div class="stor-details">${t.details}</div>`:W}
              ${t.scope?V`<div class="stor-scope">Berör: ${t.scope}</div>`:W}
            </div>
          `)}
      </div>
    ...
    `],t([gt({attribute:!1})],Ii.prototype,"config",void 0),customElements.define("hub-transit-popup",Ii);const Li=X`
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round">
    <path d="M6 6l12 12M18 6L6 18"></path>
  </svg>
`,Ri=new Intl.DateTimeFormat("sv-SE",{weekday:"short"});class Hi extends mt{constructor(){super(...arguments),this._loc=0,this._hours=[],this._days=[],this._bgOn=zt(),this._loadedFor="",this._onScrim=t=>{t.target===t.currentTarget&&this._close()}}get _locations(){const t=this.config;return t?.weather_locations?.length?t.weather_locations:t?.weather_entity?[{entity:t.weather_entity,name:"Hem"}]:[]}updated(t){const e=this._locations[this._loc]?.entity;e&&this.hass&&(t.has("hass")||t.has("config"))&&this._loadedFor!==e&&this._load(e)}async _load(t){this._loadedFor=t;const[e,i]=await Promise.all([xe(this.hass,t,"hourly"),xe(this.hass,t,"daily")]);this._loadedFor===t&&(this._hours=e?Gt(e):[],this._days=i?Wt(i):[])}_pickLoc(t){if(t===this._loc)return;this._loc=t,this._hours=[],this._days=[];const e=this._locations[t]?.entity;e&&this._load(e)}_close(){this.dispatchEvent(new CustomEvent("hub-popup-close",{bubbles:!0,composed:!0}))}_toggleBg(){this._bgOn=!this._bgOn,Ft(this._bgOn),this.dispatchEvent(new CustomEvent("hub-weather-bg-toggle",{detail:{on:this._bgOn},bubbles:!0,composed:!0}))}get _isNight(){return"below_horizon"===this.hass?.states["sun.sun"]?.state}_hero(){const t=this.getEntity(this._locations[this._loc]?.entity??"");if(!t)return W;const e=t.attributes.temperature,i=t.attributes.apparent_temperature,a=t.attributes.wind_speed,s=t.attributes.wind_speed_unit??"km/h";return V`
      <div class="hero">
        ...
        <span class="hero-meta">
          ...
          ${"number"==typeof i?V`<span>Känns som ${Math.round(i)}°</span>`:W}
          ${"number"==typeof a?V`<span>Vind ${Math.round(a)} ${s}</span>`:W}
        </span>
      </div>
      ...
      <div class="scrim" @click=${this._onScrim}>
        <div class="card" role="dialog" aria-label="Väder">
          <div class="head">
            ...
            <button class="close" aria-label="Stäng" @click=${()=>this._close()}>${Li}</button>
          </div>
          ${this._hero()}
          ${this._hourly()}
          ${this._daily()}
    ...
    `],t([gt({attribute:!1})],Hi.prototype,"config",void 0),t([bt()],Hi.prototype,"_loc",void 0),t([bt()],Hi.prototype,"_hours",void 0),t([bt()],Hi.prototype,"_days",void 0),t([bt()],Hi.prototype,"_bgOn",void 0),customElements.define("hub-weather-popup",Hi);const Ui={hem:{label:"Hem",icon:"home",tone:"neutral"},ljus:{label:"Ljus",icon:"lamp",tone:"amber"},media:{label:"Media",icon:"note",tone:"teal"},energi:{label:"Energi",icon:"bolt",tone:"green"},kcal:{label:"Kcal",icon:"ring",tone:"lavender"},vecka:{label:"Vecka",icon:"calendar",tone:"lavender"}};class Vi extends ht{constructor(){super(...arguments),this.pages=[],this.active=0}_select(t){this.dispatchEvent(new CustomEvent("hub-goto-page",{detail:{page:t},bubbles:!0,composed:!0}))}render(){return V`
      <nav>
        <div class="rail"></div>
        <div class="items">
          ${this.pages.map((t,e)=>{const i=function(t){const e=Ui[t];return e?{id:t,...e}:{id:t,label:t.charAt(0).toUpperCase()+t.slice(1),icon:"",tone:"neutral"}}(t),a=e===this.active,s=It[i.icon];return V`
              <button
                class="item tone-${i.tone} ${a?"active":""}"
                aria-label=${i.label}
                aria-current=${a?"page":W}
                @click=${()=>this._select(t)}
              >
                <span class="pill">
                  ${s?V`<span class="icon">${s}</span>`:W}
                </span>
                      ...
                      ></hub-energy-page>`:"media"===e?V`<hub-media-page
                        ...
                        ></hub-media-page>`:"kcal"===e?V`<hub-kcal-page
                          ...
                          ></hub-kcal-page>`:"vecka"===e?V`<hub-planner-page
                              .hass=${this.hass}
                              .config=${this._cfg}
                            ></hub-planner-page>`:V`<h1 class="page-placeholder">${function(t){return Gi[t]??t.charAt(0).toUpperCase()+t.slice(1)}(e)}</h1>`}
            </section>
          `)}
      </div>
