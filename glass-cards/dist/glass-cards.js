...
`,Ot={lamp:Bt(q`
  ...
  <path d="M8 18v.01M12 18v.01M16 18v.01M10 21v.01M14 21v.01" stroke-width="2.6"></path>
    ...
    `],t([gt({attribute:!1})],ke.prototype,"config",void 0),customElements.define("hub-lighting-tile",ke);class $e extends mt{constructor(){super(...arguments),this._open=()=>{this.dispatchEvent(new CustomEvent("hub-car-open",{bubbles:!0,composed:!0}))}}render(){if(!this.hass||!this.config?.volvo)return V``;const t=this.config.volvo,e=t.battery_entity?this.getEntity(t.battery_entity)?.state:void 0,i=t.range_entity?this.getEntity(t.range_entity)?.state:void 0,a=t.lock_entity?this.getEntity(t.lock_entity)?.state:void 0,s=t.charging_entity?this.getEntity(t.charging_entity)?.state:void 0,r="charging"===s||"Laddar"===s,o=[e&&!Number.isNaN(Number(e))?`${e}%`:null,i&&!Number.isNaN(Number(i))?`${i} km`:null,r?"Laddar":null].filter(Boolean);return V`
      <div class="card" role="button" tabindex="0" aria-label="Visa bilen" @click=${this._open}>
        <div class="top-row">
          <span class="ic">${Ot.car}</span>
          ${a?V`<span class="lock ${"locked"===a?"":"unlocked"}">
                ${"locked"===a?"Låst":"Olåst"}
              </span>`:X}
        </div>
        <div>
          <b class="label">${t.name??"Volvo"}</b>
          <span class="sub">${o.length?o.join(" · "):"–"}</span>
        </div>
      </div>
    `}}$e.styles=[Tt,o`
...
`;class Yi extends mt{constructor(){super(...arguments),this._onScrim=t=>{t.target===t.currentTarget&&this._close()},this._allOff=()=>{const t=[...new Set((this.config.rooms??[]).flatMap(t=>t.lights.map(t=>t.entity)))];this.hass?.callService("light","turn_off",{},{entity_id:t})}}_close(){this.dispatchEvent(new CustomEvent("hub-popup-close",{bubbles:!0,composed:!0}))}_scene(t){this.callService("scene","turn_on",void 0,t)}render(){if(!this.hass||!this.config)return V``;const t=this.config.rooms??[];return V`
    ...
    `],t([gt({attribute:!1})],Ki.prototype,"config",void 0),customElements.define("hub-vacuum-popup",Ki);class Zi extends mt{constructor(){super(...arguments),this._onScrim=t=>{t.target===t.currentTarget&&this._close()}}_close(){this.dispatchEvent(new CustomEvent("hub-popup-close",{bubbles:!0,composed:!0}))}_climate(){const t=this.config.volvo?.climate_entity;t&&(t.startsWith("switch.")?this.callService("switch","toggle",void 0,t):this.callService("button","press",void 0,t))}_climateStop(){const t=this.config.volvo?.climate_stop_entity;t&&this.callService("button","press",void 0,t)}_lockAction(t){const e=this.config.volvo?.lock_entity;e&&this.callService("lock",t,void 0,e)}_val(t,e=""){if(!t)return"–";const i=this.getEntity(t);if(!i||"unavailable"===i.state||"unknown"===i.state)return"–";const a=e||(i.attributes.unit_of_measurement??"");return a?`${i.state} ${a}`:i.state}render(){if(!this.hass||!this.config?.volvo)return V``;const t=this.config.volvo,e=t.climate_entity?this.getEntity(t.climate_entity):void 0,i="on"===e?.state,a=t.lock_entity?this.getEntity(t.lock_entity)?.state:void 0;return V`
      <div class="scrim" @click=${this._onScrim}>
        <div class="card" role="dialog" aria-label=${t.name??"Volvo"}>
          ...
          <div class="actions">
            ${t.climate_entity?V`<button class="act primary ${i?"on":""}" @click=${()=>this._climate()}>
          ...
          <div class="grid">
            ...
            <div class="row"><span class="k">Laddning</span><span class="v">${this._val(t.charging_entity)}</span></div>
            <div class="row"><span class="k">Lås</span><span class="v ${"locked"===a?"":"warn"}">${"locked"===a?"Låst":"unlocked"===a?"Olåst":"–"}</span></div>
    ...
    `],t([gt({attribute:!1})],Ji.prototype,"config",void 0),t([bt()],Ji.prototype,"_items",void 0),customElements.define("hub-todo-popup",Ji);const Qi={hem:{label:"Hem",icon:"home",tone:"neutral"},ljus:{label:"Ljus",icon:"lamp",tone:"amber"},media:{label:"Media",icon:"note",tone:"teal"},energi:{label:"Energi",icon:"bolt",tone:"green"},kcal:{label:"Kcal",icon:"ring",tone:"lavender"},vecka:{label:"Vecka",icon:"calendar",tone:"lavender"}};class ta extends ct{constructor(){super(...arguments),this.pages=[],this.active=0}_select(t){this.dispatchEvent(new CustomEvent("hub-goto-page",{detail:{page:t},bubbles:!0,composed:!0}))}render(){return V`
      <nav>
        <div class="rail"></div>
        <div class="items">
          ${this.pages.map((t,e)=>{const i=function(t){const e=Qi[t];return e?{id:t,...e}:{id:t,label:t.charAt(0).toUpperCase()+t.slice(1),icon:"",tone:"neutral"}}(t),a=e===this.active,s=Ot[i.icon];return V`
              <button
                      ...
                      ></hub-energy-page>`:"media"===e?V`<hub-media-page
                        ...
                        ></hub-media-page>`:"kcal"===e?V`<hub-kcal-page
                          ...
                          ></hub-kcal-page>`:"vecka"===e?V`<hub-planner-page
                              .hass=${this.hass}
                              .config=${this._cfg}
                            ></hub-planner-page>`:V`<h1 class="page-placeholder">${function(t){return ia[t]??t.charAt(0).toUpperCase()+t.slice(1)}(e)}</h1>`}
            </section>
          `)}
      </div>
