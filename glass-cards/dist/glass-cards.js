...
`;class ia extends mt{constructor(){super(...arguments),this._onScrim=t=>{t.target===t.currentTarget&&this._close()},this._allOff=()=>{const t=[...new Set((this.config.rooms??[]).flatMap(t=>t.lights.map(t=>t.entity)))];this.hass?.callService("light","turn_off",{},{entity_id:t})}}_close(){this.dispatchEvent(new CustomEvent("hub-popup-close",{bubbles:!0,composed:!0}))}_scene(t){this.callService("scene","turn_on",void 0,t)}render(){if(!this.hass||!this.config)return U``;const t=this.config.rooms??[];return U`
    ...
    `],t([gt({attribute:!1})],na.prototype,"config",void 0),t([bt()],na.prototype,"_items",void 0),customElements.define("hub-todo-popup",na);const oa=[{label:"30 min",min:30},{label:"1 tim",min:60},{label:"2 tim",min:120},{label:"Heldag",min:0}];class la extends mt{constructor(){super(...arguments),this._events=null,this._creating=!1,this._saving=!1,this._durMin=60,this._onScrim=t=>{t.target===t.currentTarget&&this._close()}}connectedCallback(){super.connectedCallback(),this._refresh()}async _refresh(){const t=this.config?.calendar;if(!this.hass||!t?.entities?.length)return;const e=await Pe(this.hass,t.entities);e&&(this._events=e)}_close(){this.dispatchEvent(new CustomEvent("hub-popup-close",{bubbles:!0,composed:!0}))}_input(t){return this.shadowRoot?.querySelector(t)??null}async _save(){const t=this.config?.calendar,e=this._input(".f-title")?.value.trim(),i=this._input(".f-date")?.value,a=this._input(".f-time")?.value;if(!t||!e||!i)return;this._saving=!0;const s={summary:e};if(0!==this._durMin&&a){const t=new Date(`${i}T${a}:00`),e=new Date(t.getTime()+6e4*this._durMin),r=t=>`${t.getFullYear()}-${String(t.getMonth()+1).padStart(2,"0")}-${String(t.getDate()).padStart(2,"0")}T${String(t.getHours()).padStart(2,"0")}:${String(t.getMinutes()).padStart(2,"0")}:00`;s.start_date_time=r(t),s.end_date_time=r(e)}else{const t=new Date(new Date(`${i}T00:00:00`).getTime()+864e5);s.start_date=i,s.end_date=`${t.getFullYear()}-${String(t.getMonth()+1).padStart(2,"0")}-${String(t.getDate()).padStart(2,"0")}`}try{await(this.hass?.callService("calendar","create_event",s,{entity_id:t.create_entity})),Ne=null,await this._refresh(),this._creating=!1}finally{this._saving=!1}}_grouped(){const t=new Date,e=new Map;for(const i of this._events??[]){const a=Te(i.start,t);e.has(a)||e.set(a,[]),e.get(a).push(i)}return e}_hm(t){if(t.allDay)return"Heldag";const e=new Date(t.start);return`${String(e.getHours()).padStart(2,"0")}:${String(e.getMinutes()).padStart(2,"0")}`}render(){if(!this.hass||!this.config?.calendar)return U``;const t=new Date,e=`${t.getFullYear()}-${String(t.getMonth()+1).padStart(2,"0")}-${String(t.getDate()).padStart(2,"0")}`,i=this._grouped();return U`
      <div class="scrim" @click=${this._onScrim}>
