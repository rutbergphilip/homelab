...
`;let $t=class extends ht{constructor(){super(...arguments),this._isOpen=!1,this._isClosing=!1,this._cards=[],this._onHashChange=()=>{this._checkHash()}}connectedCallback(){super.connectedCallback(),window.addEventListener("hashchange",this._onHashChange),this._checkHash()}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("hashchange",this._onHashChange)}_checkHash(){if(!this._config?.hash)return;const t=window.location.hash.replace("#","");t!==this._config.hash||this._isOpen?t!==this._config.hash&&this._isOpen&&this._close():this._open()}_open(){this._isOpen=!0,this._isClosing=!1,this._createPopupCards()}_close(){this._isClosing=!0,setTimeout(()=>{this._isOpen=!1,this._isClosing=!1},350),window.location.hash.replace("#","")===this._config.hash&&history.replaceState(null,"",window.location.pathname+window.location.search)}_handleBackdropClick(){this._close()}setConfig(t){if(!t.hash)throw new Error('glass-popup requires a "hash" property');this._config=t}set hass(t){this._hass=t,this._cards.forEach(e=>{e.hass=t})}get hass(){return this._hass}_createPopupCards(){this._config?.cards&&(this._cards=this._config.cards.map(t=>{const e=t.type?.startsWith("custom:")?t.type.replace("custom:",""):`hui-${t.type}-card`,i=document.createElement(e);return"function"==typeof i.setConfig&&i.setConfig(t),this.hass&&(i.hass=this.hass),i}),this.requestUpdate())}render(){return this._isOpen||this._isClosing?V`
  ...
  `,t([gt({attribute:!1})],Et.prototype,"hass",void 0),t([gt({attribute:!1})],Et.prototype,"_config",void 0),t([bt()],Et.prototype,"_activeHash",void 0),Et=t([dt("glass-nav-bar")],Et);let Ct=class extends mt{get _vacuumConfig(){return this._config}setConfig(t){super.setConfig(t),t.entity&&this.setTrackedEntities([t.entity])}_getStatusText(t){return{cleaning:"Stader",docked:"Dockad",paused:"Pausad",returning:"Atergar",idle:"Inaktiv",error:"Fel",unavailable:"Otillganglig"}[t]??t}_start(){this._config.entity&&this.callService("vacuum","start",void 0,this._config.entity)}_stop(){this._config.entity&&this.callService("vacuum","return_to_base",void 0,this._config.entity)}_cleanRoom(t){this._config.entity&&null!=t.room_id&&this.callService("vacuum","send_command",{command:"app_segment_clean",params:[t.room_id]},this._config.entity)}render(){if(!this.hass||!this._config?.entity)return V``;const t=this.getEntity(this._config.entity);if(!t)return V``;const e=t.state,i="cleaning"===e,a="error"===e,s=t.attributes.battery_level,r=this._config.name??t.attributes.friendly_name??"Vacuum",n=this._config.icon??"mdi:robot-vacuum";return V`
    ...
    `:V``}getCardSize(){return 0}};Mt.styles=n`
    :host { display: block; }
    .section {
      display: flex;
      align-items: center;
...
`,Pt="glass-hub-theme";const Nt="glass-hub-weather-bg";function Ft(){return"off"!==localStorage.getItem(Nt)}function zt(t){localStorage.setItem(Nt,t?"on":"off")}let Dt=null;function Bt(){return Dt}function jt(t,e=8){return Math.abs(t)>e}const Ot=t=>X`
...
`,Lt={lamp:Ot(X`
  ...
  `)},It={sunny:{sky:"clear",clouds:0,sun:!0,stars:!0,rain:0,snow:0,hail:0,lightning:!1,fog:!1,wind:1},"clear-night":{sky:"clear",clouds:0,sun:!1,stars:!0,rain:0,snow:0,hail:0,lightning:!1,fog:!1,wind:1},partlycloudy:{sky:"partly",clouds:.35,sun:!0,stars:!0,rain:0,snow:0,hail:0,lightning:!1,fog:!1,wind:1},cloudy:{sky:"overcast",clouds:.85,sun:!1,stars:!1,rain:0,snow:0,hail:0,lightning:!1,fog:!1,wind:1},rainy:{sky:"storm",clouds:.7,sun:!1,stars:!1,rain:110,snow:0,hail:0,lightning:!1,fog:!1,wind:1.2},pouring:{sky:"storm",clouds:.9,sun:!1,stars:!1,rain:260,snow:0,hail:0,lightning:!1,fog:!1,wind:1.5},snowy:{sky:"overcast",clouds:.7,sun:!1,stars:!1,rain:0,snow:70,hail:0,lightning:!1,fog:!1,wind:1},"snowy-rainy":{sky:"storm",clouds:.8,sun:!1,stars:!1,rain:70,snow:45,hail:0,lightning:!1,fog:!1,wind:1.2},lightning:{sky:"storm",clouds:.9,sun:!1,stars:!1,rain:0,snow:0,hail:0,lightning:!0,fog:!1,wind:1.4},"lightning-rainy":{sky:"storm",clouds:.9,sun:!1,stars:!1,rain:170,snow:0,hail:0,lightning:!0,fog:!1,wind:1.6},fog:{sky:"fog",clouds:.45,sun:!1,stars:!1,rain:0,snow:0,hail:0,lightning:!1,fog:!0,wind:.5},hail:{sky:"storm",clouds:.8,sun:!1,stars:!1,rain:40,snow:0,hail:120,lightning:!1,fog:!1,wind:1.3},windy:{sky:"partly",clouds:.5,sun:!1,stars:!1,rain:0,snow:0,hail:0,lightning:!1,fog:!1,wind:2.6},"windy-variant":{sky:"partly",clouds:.5,sun:!1,stars:!1,rain:0,snow:0,hail:0,lightning:!1,fog:!1,wind:2.6}};function Rt(t){return It[t]??It.cloudy}function Ht(t){return null===t?"night":t>10?"day":t>-4?"golden":"night"}const Ut={clear:["#04060C","#070B14","#0B1220"],partly:["#05060B","#090C12","#10141C"],overcast:["#060708","#0A0B0D","#101214"],storm:["#050607","#0A0B0E","#12141A"],fog:["#08090B","#0E1013","#16181C"]},Vt={day:{clear:["#4A85C7","#8CB8E3","#D6E7F4"],partly:["#5E8FC0","#93B7DB","#D3E2EE"],overcast:["#8A97A5","#AEB8C2","#D5DADF"],storm:["#4E5A68","#6E7B89","#9AA5B0"],fog:["#A8AFB5","#C2C7CB","#DCDFE1"]},golden:{clear:["#3E6CA8","#C98A5E","#F2C98E"],partly:["#4A6E9E","#B98963","#E8C393"],overcast:["#77808D","#9C9997","#C4B4A4"],storm:["#45505E","#6B6E75","#8F8578"],fog:["#9AA0A8","#B8B4AE","#D6CDC0"]},night:{clear:["#101B30","#1A2A47","#2A3C5C"],partly:["#12192A","#1C2740","#2B3852"],overcast:["#1A1E26","#242A34","#323844"],storm:["#151820","#20242E","#2E323E"],fog:["#1D2026","#282C33","#383C44"]}};function Xt(t){const e="string"==typeof t.datetime?Date.parse(t.datetime):NaN;return Number.isNaN(e)?NaN:e}function Wt(t){if(!Array.isArray(t))return[];const e=[];for(const i of t){if(!i||"object"!=typeof i)continue;const t=Xt(i);Number.isNaN(t)||"number"!=typeof i.temperature||e.push({ts:t,temp:i.temperature,condition:"string"==typeof i.condition?i.condition:"cloudy",precip:"number"==typeof i.precipitation?i.precipitation:0,precipProb:"number"==typeof i.precipitation_probability?i.precipitation_probability:null})}return e.sort((t,e)=>t.ts-e.ts)}function qt(t){if(!Array.isArray(t))return[];const e=[];for(const i of t){if(!i||"object"!=typeof i)continue;const t=Xt(i);Number.isNaN(t)||"number"!=typeof i.temperature||e.push({ts:t,condition:"string"==typeof i.condition?i.condition:"cloudy",high:i.temperature,low:"number"==typeof i.templow?i.templow:null,precipProb:"number"==typeof i.precipitation_probability?i.precipitation_probability:null})}return e.sort((t,e)=>t.ts-e.ts)}const Gt=new Set(["rainy","pouring","snowy","snowy-rainy","lightning-rainy","hail"]),Yt=new Set(["snowy","snowy-rainy"]);function Kt(t){return Gt.has(t)}function Zt(t){return`${String(new Date(t).getHours()).padStart(2,"0")}:00`}const Jt={clear:{lit:[.16,.18,.23],shade:[.05,.06,.09],alpha:.75},partly:{lit:[.16,.18,.23],shade:[.05,.06,.09],alpha:.8},overcast:{lit:[.13,.14,.17],shade:[.04,.045,.06],alpha:.85},storm:{lit:[.12,.13,.16],shade:[.03,.035,.05],alpha:.9},fog:{lit:[.16,.17,.2],shade:[.07,.08,.1],alpha:.6}},Qt={clear:{lit:[1,1,1],shade:[.62,.66,.72],alpha:.92},partly:{lit:[1,1,1],shade:[.62,.66,.72],alpha:.92},overcast:{lit:[.82,.85,.88],shade:[.45,.49,.55],alpha:.95},storm:{lit:[.62,.66,.72],shade:[.28,.31,.37],alpha:.95},fog:{lit:[.88,.89,.9],shade:[.65,.67,.69],alpha:.7}};class te{constructor(t){this.canvas=t,this.ok=!1,this.gl=null,this.prog=null,this.u={},this._onLost=t=>{t.preventDefault(),this.ok=!1},this._onRestored=()=>{this._init()},t.addEventListener("webglcontextlost",this._onLost),t.addEventListener("webglcontextrestored",this._onRestored),this._init()}_init(){this.ok=!1;const t=this.canvas.getContext("webgl",{alpha:!0,premultipliedAlpha:!0,antialias:!1,depth:!1,stencil:!1});if(!t)return;const e=(e,i)=>{const a=t.createShader(e);return a?(t.shaderSource(a,i),t.compileShader(a),t.getShaderParameter(a,t.COMPILE_STATUS)?a:(console.debug("[cloud-shader] compile failed:",t.getShaderInfoLog(a)),null)):null},i=e(t.VERTEX_SHADER,"\nattribute vec2 a_pos;\nvoid main() { gl_Position = vec4(a_pos, 0.0, 1.0); }\n"),a=e(t.FRAGMENT_SHADER,"\nprecision mediump float;\nuniform vec2 u_res;\nuniform float u_time;\nuniform float u_density;\nuniform float u_wind;\nuniform vec3 u_lit;\nuniform vec3 u_shade;\nuniform float u_alpha;\nuniform float u_flash;\n\nfloat hash(vec2 p) {\n  p = fract(p * vec2(127.1, 311.7));\n  p += dot(p, p + 34.23);\n  return fract(p.x * p.y);\n}\nfloat noise(vec2 p) {\n  vec2 i = floor(p);\n  vec2 f = fract(p);\n  f = f * f * (3.0 - 2.0 * f);\n  return mix(\n    mix(hash(i), hash(i + vec2(1.0, 0.0)), f.x),\n    mix(hash(i + vec2(0.0, 1.0)), hash(i + vec2(1.0, 1.0)), f.x),\n    f.y);\n}\nfloat fbm(vec2 p) {\n  float v = 0.0;\n  float a = 0.5;\n  for (int i = 0; i < 5; i++) {\n    v += a * noise(p);\n    p = p * 2.03 + vec2(19.3, 7.1);\n    a *= 0.5;\n  }\n  return v;\n}\nvoid main() {\n  vec2 uv = gl_FragCoord.xy / u_res;\n  // Aspect-corrected, vertically squashed noise space -> wide cloud banks.\n  vec2 p = vec2(uv.x * (u_res.x / u_res.y), uv.y * 1.9);\n  float t = u_time * 0.014 * u_wind;\n  // Large slow masses + domain-warped turbulent detail.\n  float base = fbm(p * 1.5 + vec2(t, 0.0));\n  vec2 q = vec2(\n    fbm(p * 2.8 + vec2(t * 2.2, 1.7)),\n    fbm(p * 2.8 + vec2(8.3 - t * 1.4, 2.8)));\n  float detail = fbm(p * 4.2 + q * 1.7 + vec2(t * 3.5, 0.0));\n  float f = base * 0.62 + detail * 0.55 + (uv.y - 0.5) * 0.12;\n  float th = mix(0.86, 0.32, u_density);\n  float cov = smoothstep(th, th + 0.28, f);\n  // Denser core = darker (self-shadowing); lightning lifts the whole field.\n  vec3 col = mix(u_lit, u_shade, smoothstep(th + 0.05, th + 0.55, f));\n  col += vec3(u_flash * 0.45);\n  float a = min(cov * u_alpha * (1.0 + u_flash * 0.25), 1.0);\n  gl_FragColor = vec4(col * a, a); // premultiplied\n}\n");if(!i||!a)return;const s=t.createProgram();if(!s)return;if(t.attachShader(s,i),t.attachShader(s,a),t.linkProgram(s),!t.getProgramParameter(s,t.LINK_STATUS))return void console.debug("[cloud-shader] link failed:",t.getProgramInfoLog(s));t.useProgram(s);const r=t.createBuffer();t.bindBuffer(t.ARRAY_BUFFER,r),t.bufferData(t.ARRAY_BUFFER,new Float32Array([-1,-1,3,-1,-1,3]),t.STATIC_DRAW);const n=t.getAttribLocation(s,"a_pos");t.enableVertexAttribArray(n),t.vertexAttribPointer(n,2,t.FLOAT,!1,0,0);for(const e of["u_res","u_time","u_density","u_wind","u_lit","u_shade","u_alpha","u_flash"])this.u[e]=t.getUniformLocation(s,e);t.enable(t.BLEND),t.blendFunc(t.ONE,t.ONE_MINUS_SRC_ALPHA),t.clearColor(0,0,0,0),this.gl=t,this.prog=s,this.ok=!0}render(t){const e=this.gl;e&&this.ok&&(e.viewport(0,0,this.canvas.width,this.canvas.height),e.clear(e.COLOR_BUFFER_BIT),e.uniform2f(this.u.u_res,this.canvas.width,this.canvas.height),e.uniform1f(this.u.u_time,t.time),e.uniform1f(this.u.u_density,t.density),e.uniform1f(this.u.u_wind,t.wind),e.uniform3f(this.u.u_lit,...t.palette.lit),e.uniform3f(this.u.u_shade,...t.palette.shade),e.uniform1f(this.u.u_alpha,t.palette.alpha),e.uniform1f(this.u.u_flash,t.flash),e.drawArrays(e.TRIANGLES,0,3))}clear(){const t=this.gl;t&&this.ok&&(t.viewport(0,0,this.canvas.width,this.canvas.height),t.clear(t.COLOR_BUFFER_BIT))}dispose(){this.canvas.removeEventListener("webglcontextlost",this._onLost),this.canvas.removeEventListener("webglcontextrestored",this._onRestored),this.gl&&this.prog&&this.gl.deleteProgram(this.prog),this.gl=null,this.prog=null,this.ok=!1}}const ee=[{scale:.55,alpha:.3,speed:.6},{scale:.8,alpha:.55,speed:.85},{scale:1.15,alpha:.9,speed:1.15}];class ie extends mt{constructor(){super(...arguments),this.theme="natt",this.active=!1,this._skyA="",this._skyB="",this._frontA=!0,this._vidSrcA="",this._vidSrcB="",this._vidFrontA=!0,this._activeVidSrc="",this._videoDead=!1,this._band="night",this._clipName=null,this._w=0,this._h=0,this._dpr=1,this._running=!1,this._raf=0,this._last=0,this._t=0,this._scene=Rt("cloudy"),this._sceneKey="",this._drops=[],this._flakes=[],this._stones=[],this._splashes=[],this._clouds=[],this._stars=[],this._fogOffsets=[0,0,0],this._flash=0,this._nextFlash=0,this._bolt=null,this._onVisibility=()=>this._maybeRun(),this._onForce=()=>this.requestUpdate(),this._onVideoError=()=>{console.debug("[weather-bg] video failed — falling back to shader clouds"),this._videoDead=!0,this._activeVidSrc="",this._vidSrcA="",this._vidSrcB="",this._sceneKey="",this.requestUpdate()},this._frame=t=>{if(!this._running)return;const e=Math.min((t-this._last)/1e3,.05);this._last=t,this._t+=e,this._draw(e),this._raf=requestAnimationFrame(this._frame)}}connectedCallback(){super.connectedCallback(),document.addEventListener("visibilitychange",this._onVisibility),window.addEventListener("hub-weather-force",this._onForce)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("visibilitychange",this._onVisibility),window.removeEventListener("hub-weather-force",this._onForce),this._ro?.disconnect(),this._ro=void 0,this._shader?.dispose(),this._shader=void 0,void 0!==this._vidSwapTimer&&(clearTimeout(this._vidSwapTimer),this._vidSwapTimer=void 0),this._stopLoop()}firstUpdated(){this._canvas=this.renderRoot.querySelector("canvas.px")??void 0,this._ctx=this._canvas?.getContext("2d")??void 0,this._glCanvas=this.renderRoot.querySelector("canvas.gl")??void 0,this._glCanvas&&(this._shader=new te(this._glCanvas)),this._ro=new ResizeObserver(()=>this._resize()),this._ro.observe(this),this._resize()}updated(t){this._syncScene(),t.has("active")&&this._maybeRun()}get _condition(){return Bt()??this.getEntity(this.entity)?.state??"cloudy"}get _elevation(){const t=this.hass?.states["sun.sun"]?.attributes?.elevation;return"number"==typeof t?t:null}_syncScene(){const t=Ht(this._elevation),e=this._condition,i=`${e}|${this.theme}|${t}`;if(i===this._sceneKey)return;this._sceneKey=i,this._band=t,this._scene=Rt(e);const a=this._videoDead?null:function(t,e){const i="night"!==e;switch(t){case"sunny":case"clear-night":return i?"sunny-day":"clear-night";case"partlycloudy":case"windy":case"windy-variant":return i?"partly-day":"clear-night";case"cloudy":default:return i?"cloudy-day":"cloudy-night";case"rainy":case"pouring":case"lightning":case"lightning-rainy":case"hail":return i?"storm-day":"cloudy-night";case"snowy":case"snowy-rainy":return i?"snow-day":"cloudy-night";case"fog":return"fog"}}(e,t);this._clipName=a;const s=a?`/local/glass-cards/weather/${a}.mp4`:"";s!==this._activeVidSrc&&(this._activeVidSrc=s,this._swapVideo(s));const[r,n,o]=function(t,e,i){return"natt"===e?Ut[t]:Vt[i][t]}(this._scene.sky,this.theme,t),l=`background:linear-gradient(180deg, ${r} 0%, ${n} 55%, ${o} 100%)`;this._frontA?(this._skyB=l,this._frontA=!1):(this._skyA=l,this._frontA=!0),this._buildSprites(),this._buildParticles(),this._nextFlash=this._t+2+5*Math.random(),this._maybeRun()}_resize(){this._canvas&&(this._w=this.offsetWidth,this._h=this.offsetHeight,this._dpr=Math.min(window.devicePixelRatio||1,1.5),this._canvas.width=Math.max(1,Math.round(this._w*this._dpr)),this._canvas.height=Math.max(1,Math.round(this._h*this._dpr)),this._glCanvas&&(this._glCanvas.width=Math.max(1,Math.round(this._w*this._dpr/2)),this._glCanvas.height=Math.max(1,Math.round(this._h*this._dpr/2))),this._buildParticles())}get _isNightBand(){return"night"===Ht(this._elevation)}get _videoOn(){return""!==this._activeVidSrc&&!this._videoDead}_swapVideo(t){if(void 0!==this._vidSwapTimer&&(clearTimeout(this._vidSwapTimer),this._vidSwapTimer=void 0),!t)return this._vidSrcA="",void(this._vidSrcB="");this._vidFrontA?(this._vidSrcB=t,this._vidFrontA=!1):(this._vidSrcA=t,this._vidFrontA=!0),this.updateComplete.then(()=>{this._playVideos(),this._vidSwapTimer=window.setTimeout(()=>{this._vidFrontA?this._vidSrcB="":this._vidSrcA=""},1700)})}_videos(){return Array.from(this.renderRoot.querySelectorAll("video"))}_playVideos(){if(this._running)for(const t of this._videos())t.play().catch(()=>{})}_pauseVideos(){for(const t of this._videos())t.pause()}_perMp(t){return Math.round(t*this._w*this._h/1e6)}_buildParticles(){const t=this._scene,e=this._w,i=this._h;if(0===e||0===i)return;const a=Math.random;this._drops=Array.from({length:this._perMp(t.rain)},()=>({x:a()*e,y:a()*i,layer:Math.floor(a()*ee.length),jl:.7+.6*a(),js:.85+.35*a(),ja:40*(a()-.5)})),this._flakes=Array.from({length:this._perMp(t.snow)},()=>({x:a()*e,y:a()*i,r:1.5+2.5*a(),phase:a()*Math.PI*2,rot:a()*Math.PI*2,rotSpd:1.2*(a()-.5),layer:Math.floor(a()*ee.length)})),this._stones=Array.from({length:this._perMp(t.hail)},()=>({x:a()*e,y:a()*i,vy:700+300*a(),vx:60*(a()-.5),r:1.2+1.6*a(),bounced:!1}));const s=t.clouds>0?Math.round(2+5*t.clouds):0;this._clouds=Array.from({length:s},(t,r)=>({x:a()*e*1.4-.2*e,y:r/Math.max(s,1)*i*.38+30*a(),scale:.7+.9*a(),spd:6+10*a(),alpha:.5+.5*a()})),this._stars=t.stars?Array.from({length:90},()=>({x:a()*e,y:a()*i*.7,r:.5+1.1*a(),phase:a()*Math.PI*2})):[],this._splashes=[]}_buildSprites(){const t=document.createElement("canvas");t.width=512,t.height=256;const e=t.getContext("2d"),i="natt"===this.theme,a="storm"===this._scene.sky,[s,r,n]=i?[26,30,40]:a?[120,130,142]:[255,255,255];for(let t=0;t<9;t++){const t=80+352*Math.random(),a=90+80*Math.random(),o=55+70*Math.random(),l=e.createRadialGradient(t,a,0,t,a,o);l.addColorStop(0,`rgba(${s},${r},${n},${i?.5:.55})`),l.addColorStop(1,`rgba(${s},${r},${n},0)`),e.fillStyle=l,e.fillRect(0,0,512,256)}this._cloudSprite=t;const o=document.createElement("canvas");o.width=32,o.height=32;const l=o.getContext("2d"),h=l.createRadialGradient(16,16,0,16,16,14);h.addColorStop(0,"rgba(255,255,255,0.9)"),h.addColorStop(.5,"rgba(255,255,255,0.35)"),h.addColorStop(1,"rgba(255,255,255,0)"),l.fillStyle=h,l.fillRect(0,0,32,32),l.strokeStyle="rgba(255,255,255,0.5)",l.lineWidth=1.2;for(let t=0;t<3;t++)l.save(),l.translate(16,16),l.rotate(t*Math.PI/3),l.beginPath(),l.moveTo(-7,0),l.lineTo(7,0),l.stroke(),l.restore();this._flakeSprite=o}_maybeRun(){const t=this._scene.rain>0||this._scene.snow>0||this._scene.hail>0||this._scene.clouds>0||this._scene.stars||this._scene.sun||this._scene.fog||this._scene.lightning||this._videoOn,e=this.active&&t&&this.isConnected&&"visible"===document.visibilityState;e&&!this._running?(this._running=!0,this._last=performance.now(),console.debug("[weather-bg] start"),this._playVideos(),this._raf=requestAnimationFrame(this._frame)):!e&&this._running&&this._stopLoop()}_stopLoop(){this._running&&(this._running=!1,cancelAnimationFrame(this._raf),this._pauseVideos(),console.debug("[weather-bg] stop"))}_draw(t){const e=this._ctx;if(!e)return;const i=this._w,a=this._h;e.setTransform(this._dpr,0,0,this._dpr,0,0),e.clearRect(0,0,i,a),this._updateFlash(t);const s=this._videoOn;!s&&this._stars.length&&this._isNightBand&&this._drawStars(e),s||!this._scene.sun||this._isNightBand||"dag"!==this.theme||this._drawSun(e,i,a);var r,n;if(!0===this._shader?.ok?!s&&this._scene.clouds>0?this._shader.render({time:this._t,density:this._scene.clouds,wind:this._scene.wind,palette:(r=this._scene.sky,n=this.theme,"natt"===n?Jt[r]:Qt[r]),flash:this._flash}):this._shader.clear():!s&&this._clouds.length&&this._drawClouds(e,t,i,a),!s&&this._scene.fog&&this._drawFog(e,t,i,a),this._drops.length&&this._drawRain(e,t,i,a),this._flakes.length&&this._drawSnow(e,t,i,a),this._stones.length&&this._drawHail(e,t,i,a),this._splashes.length&&this._drawSplashes(e,t),this._flash>.01){const t=("natt"===this.theme?.22:.3)*(this._bolt?.6:1);e.fillStyle=`rgba(215,225,255,${this._flash*t})`,e.fillRect(0,0,i,a)}this._bolt&&this._flash>.05&&this._drawBolt(e)}_drawStars(t){for(const e of this._stars){const i=.25+.5*Math.abs(Math.sin(.5*this._t+e.phase));t.fillStyle=`rgba(200,215,255,${i})`,t.beginPath(),t.arc(e.x,e.y,e.r,0,2*Math.PI),t.fill()}}_drawSun(t,e,i){const a=.76*e,s=.2*i,r="golden"===Ht(this._elevation),n=.55*Math.min(e,i),o=.92+.08*Math.sin(.3*this._t),l=r?"255,170,90":"255,218,130";let h=t.createRadialGradient(a,s,0,a,s,n);h.addColorStop(0,`rgba(255,246,220,${.85*o})`),h.addColorStop(.12,`rgba(${l},${.5*o})`),h.addColorStop(.35,`rgba(${l},0.16)`),h.addColorStop(1,`rgba(${l},0)`),t.fillStyle=h,t.fillRect(0,0,e,i);const c=.52*n;h=t.createRadialGradient(a,s,.88*c,a,s,1.12*c),h.addColorStop(0,`rgba(${l},0)`),h.addColorStop(.5,`rgba(${l},0.1)`),h.addColorStop(1,`rgba(${l},0)`),t.fillStyle=h;const d=1.15*c;t.fillRect(a-d,s-d,2*d,2*d),t.save(),t.translate(a,s),t.rotate(.02*this._t),t.fillStyle=`rgba(${l},0.07)`;for(let e=0;e<8;e++)t.rotate(Math.PI/4),t.beginPath(),t.moveTo(0,0),t.lineTo(1.1*n,.045*-n),t.lineTo(1.1*n,.045*n),t.closePath(),t.fill();t.restore();const p=e/2-a,u=i/2-s,g=[[.7,14,.06],[1.4,9,.08],[2.1,22,.045]];for(const[e,i,r]of g){const n=a+p*e,o=s+u*e,h=t.createRadialGradient(n,o,0,n,o,i);h.addColorStop(0,`rgba(${l},${r})`),h.addColorStop(1,`rgba(${l},0)`),t.fillStyle=h,t.fillRect(n-i,o-i,2*i,2*i)}}_drawClouds(t,e,i,a){const s=this._cloudSprite;if(!s)return;const r=this._scene.wind;for(const a of this._clouds){a.x+=a.spd*r*e;const n=512*a.scale*.9;a.x-n/2>i&&(a.x=-n/2),t.globalAlpha=a.alpha*(.35+.5*this._scene.clouds)+.3*this._flash,t.drawImage(s,a.x-n/2,a.y-128*a.scale/2,n,256*a.scale*.9)}t.globalAlpha=1}_drawFog(t,e,i,a){const s="natt"===this.theme,[r,n,o]=s?[40,44,52]:[225,228,230],l=s?[.1,.14,.18]:[.16,.22,.28];for(let s=0;s<3;s++){const h=s%2==0?1:-1;this._fogOffsets[s]=(this._fogOffsets[s]+h*(4+3*s)*e+i)%i;const c=a*(.35+.22*s),d=t.createLinearGradient(0,c-70,0,c+70);d.addColorStop(0,`rgba(${r},${n},${o},0)`),d.addColorStop(.5,`rgba(${r},${n},${o},${l[s]})`),d.addColorStop(1,`rgba(${r},${n},${o},0)`),t.fillStyle=d,t.fillRect(this._fogOffsets[s]-i,c-70,i,140),t.fillRect(this._fogOffsets[s],c-70,i,140)}}_drawRain(t,e,i,a){const s=this._scene.wind,r="natt"===this.theme,n=this._scene.rain>150?1500:1150,o=this._scene.rain>150?30:20;t.lineCap="round";for(const l of this._drops){const h=ee[l.layer],c=n*h.speed*l.js,d=(60*s+l.ja)*h.speed;l.y+=c*e,l.x+=d*e,l.y>a&&(l.y=-o,l.x=Math.random()*i,2===l.layer&&Math.random()<.25&&this._splashes.push({x:l.x,y:a-4-8*Math.random(),r:1,life:1})),l.x>i&&(l.x-=i);const p=o*h.scale*l.jl,u=d/c*p;t.strokeStyle=r?`rgba(150,170,200,${.45*h.alpha})`:`rgba(235,242,250,${.6*h.alpha})`,t.lineWidth=1*h.scale,t.beginPath(),t.moveTo(l.x,l.y),t.lineTo(l.x-u,l.y-p),t.stroke()}}_drawSnow(t,e,i,a){const s=this._flakeSprite;if(!s)return;const r=this._scene.wind;for(const n of this._flakes){const o=ee[n.layer];n.y+=55*o.speed*e,n.x+=20*Math.sin(n.phase+.8*this._t)*r*e,n.rot+=n.rotSpd*e,n.y>a+6&&(n.y=-6,n.x=Math.random()*i),n.x>i+6&&(n.x=-6),n.x<-6&&(n.x=i+6);const l=4*n.r*o.scale;t.save(),t.globalAlpha=o.alpha*("natt"===this.theme?.7:.95),t.translate(n.x,n.y),t.rotate(n.rot),t.drawImage(s,-l/2,-l/2,l,l),t.restore()}t.globalAlpha=1}_drawHail(t,e,i,a){const s="natt"===this.theme;t.fillStyle=s?"rgba(190,205,225,0.7)":"rgba(250,252,255,0.9)";for(const s of this._stones)s.y+=s.vy*e,s.x+=s.vx*e,s.y>a?!s.bounced&&Math.random()<.5?(s.bounced=!0,s.vy=.35*-s.vy,s.y=a):(s.y=-4,s.x=Math.random()*i,s.vy=700+300*Math.random(),s.bounced=!1):s.bounced&&(s.vy+=1600*e),t.beginPath(),t.arc(s.x,s.y,s.r,0,2*Math.PI),t.fill()}_drawSplashes(t,e){const i="natt"===this.theme;for(const a of this._splashes)a.r+=50*e,a.life-=5*e,a.life<=0||(t.strokeStyle=i?`rgba(150,170,200,${.2*a.life})`:`rgba(235,242,250,${.3*a.life})`,t.lineWidth=1,t.beginPath(),t.ellipse(a.x,a.y,a.r,.35*a.r,0,0,2*Math.PI),t.stroke());this._splashes=this._splashes.filter(t=>t.life>0)}_updateFlash(t){if(!this._scene.lightning)return this._flash=0,void(this._bolt=null);this._t>=this._nextFlash?(this._flash=1,this._bolt=Math.random()<.7?this._makeBolt():null,this._nextFlash=this._t+(Math.random()<.3?.15:4+8*Math.random())):this._flash=Math.max(0,this._flash-t/.4)**1.5}_makeBolt(){const t=this._w,e=this._h,i=Math.random,a=[],s=[];let r=t*(.2+.6*i()),n=-8;const o=10*(i()-.5),l=e*(.55+.3*i());for(s.push([r,n]);n<l;)if(n+=12+22*i(),r+=36*(i()-.5)+o,s.push([r,n]),i()<.14&&s.length>2){const t=[[r,n]];let e=r,s=n;const o=i()<.5?-1:1,l=3+Math.floor(4*i());for(let a=0;a<l;a++)s+=10+16*i(),e+=o*(8+20*i())+12*(i()-.5),t.push([e,s]);a.push(t)}return a.unshift(s),a}_drawBolt(t){const e=this._bolt;if(!e)return;const i=this._flash,a=[[10,`rgba(120,170,255,${.25*i})`],[4.5,`rgba(170,205,255,${.45*i})`],[2.5,`rgba(255,255,255,${.95*i})`]];t.lineCap="round",t.lineJoin="round";for(const[i,s]of a)t.strokeStyle=s,e.forEach((e,a)=>{t.lineWidth=0===a?i:.55*i,t.beginPath(),t.moveTo(e[0][0],e[0][1]);for(let i=1;i<e.length;i++)t.lineTo(e[i][0],e[i][1]);t.stroke()})}render(){const t="natt"!==this.theme||null===this._clipName||this._clipName.endsWith("-night")?"":"dim",e=(e,i)=>e?V`<video
      ...
      ${e(this._vidSrcA,this._vidFrontA)} ${e(this._vidSrcB,!this._vidFrontA)}
      ${this._videoOn?V`<div class="scrim"></div>`:q}
  ...
  `,t([gt({attribute:!1})],ie.prototype,"entity",void 0),t([gt({attribute:!1})],ie.prototype,"theme",void 0),t([gt({attribute:!1})],ie.prototype,"active",void 0),t([bt()],ie.prototype,"_skyA",void 0),t([bt()],ie.prototype,"_skyB",void 0),t([bt()],ie.prototype,"_frontA",void 0),t([bt()],ie.prototype,"_vidSrcA",void 0),t([bt()],ie.prototype,"_vidSrcB",void 0),t([bt()],ie.prototype,"_vidFrontA",void 0),customElements.define("hub-weather-bg",ie);const ae=X`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
...
</svg>`,ve={sunny:{day:ae,night:se},"clear-night":{day:se},partlycloudy:{day:ne,night:oe},cloudy:{day:re},rainy:{day:le},pouring:{day:he},snowy:{day:ce},"snowy-rainy":{day:de},lightning:{day:pe},"lightning-rainy":{day:ue},fog:{day:ge},hail:{day:X`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
  <path d="M6.5 14.5a4 4 0 0 1-.4-8 5.2 5.2 0 0 1 10.1-1.2 3.9 3.9 0 0 1 1.3 7.6 4 4 0 0 1-1.5.3z"></path>
  <path d="M8 18v.01M12 18v.01M16 18v.01M10 21v.01M14 21v.01" stroke-width="2.6"></path>
    ...
    `],t([gt({attribute:!1})],$e.prototype,"room",void 0),t([bt()],$e.prototype,"_flash",void 0),customElements.define("hub-room-tile",$e);const Ee=new Set(["off","unavailable","unknown","standby","idle"]);function Ce(t,e){for(const i of e){const e=t[i.entity];if(e&&"playing"===e.state)return{entity:e,name:i.name}}for(const i of e){const e=t[i.entity];if(e&&!Ee.has(e.state))return{entity:e,name:i.name}}return null}function Se(t,e){if(!t)return 0;const i=t.attributes,a="number"==typeof i.media_duration?i.media_duration:0;if(a<=0)return 0;let s="number"==typeof i.media_position?i.media_position:0;const r="string"==typeof i.media_position_updated_at?Date.parse(i.media_position_updated_at):NaN;return"playing"!==t.state||Number.isNaN(r)||(s+=(e-r)/1e3),Math.max(0,Math.min(100,s/a*100))}class Me extends mt{constructor(){super(...arguments),this.players=[],this._now=Date.now()}connectedCallback(){super.connectedCallback(),this._interval=window.setInterval(()=>{this._now=Date.now()},1e3)}disconnectedCallback(){super.disconnectedCallback(),void 0!==this._interval&&(clearInterval(this._interval),this._interval=void 0)}_goto(){this.dispatchEvent(new CustomEvent("hub-goto-page",{detail:{page:"media"},bubbles:!0,composed:!0}))}_togglePlay(t,e){t.stopPropagation(),this.callService("media_player","media_play_pause",void 0,e)}render(){if(!this.hass)return V``;const t=Ce(this.hass.states,this.players??[]);if(!t)return V`
        <div class="np idle" @click=${this._goto}>
          <span class="idle-ic">${Lt.note}</span>
          <b class="title dim">Ingenting spelas</b>
        </div>
      `;const e=t.entity,i="playing"===e.state,a=e.attributes.media_title||t.name,s=e.attributes.media_artist||t.name,r=e.attributes.entity_picture,n=Se(e,this._now);return V`
      <div class="np ${i?"playing":""}" @click=${this._goto}>
        ...
        >
          <span class="ppic">${i?Lt.pause:Lt.play}</span>
        </button>
      </div>
    `}}Me.styles=[Tt,n`
      :host {
    ...
    `],t([gt({attribute:!1})],Me.prototype,"players",void 0),t([bt()],Me.prototype,"_now",void 0),customElements.define("hub-now-playing",Me);const Ae=new Intl.NumberFormat("sv-SE");function Te(t,e){return e>0?Math.max(0,Math.min(100,t/e*100)):0}class Pe extends mt{_goto(){this.dispatchEvent(new CustomEvent("hub-goto-page",{detail:{page:"kcal"},bubbles:!0,composed:!0}))}render(){if(!this.hass)return V``;const t=this.todayEntity?this.getEntity(this.todayEntity):void 0,e=t?Number(t.state):NaN;if(!t||"unavailable"===t.state||"unknown"===t.state||Number.isNaN(e))return V`
        <div class="kc offline" @click=${this._goto}>
          <div class="ring" style="--pct:0"></div>
          <div class="meta"><b class="val">Kcal · offline</b></div>
        </div>
      `;const i="number"==typeof t.attributes.kcal_target?t.attributes.kcal_target:0,a=Te(e,i),s=function(t){const e=t.protein_g;return"number"==typeof e?`${Math.round(e)} g protein`:""}(t.attributes);return V`
      <div class="kc" @click=${this._goto}>
        <div class="ring" style="--pct:${a}"></div>
        <div class="meta">
          <b class="val">
            ${Ae.format(Math.round(e))}
            <span class="target">
              ${i>0?`/ ${Ae.format(i)} kcal`:"kcal"}
            </span>
          </b>
    ...
    `],t([gt({attribute:!1})],Pe.prototype,"todayEntity",void 0),customElements.define("hub-kcal-ring",Pe);const Ne={frukost:"Frukost",lunch:"Lunch",middag:"Middag",mellis:"Mellis"},Fe=["frukost","lunch","middag","mellis"],ze={gymdag:"G",vilodag:"V",flexdag:"F"};const De=/^\d{4}-\d{2}-\d{2}$/;function Be(t){if(!t||"object"!=typeof t)return null;const e=t;if("frukost"!==(i=e.slot)&&"lunch"!==i&&"middag"!==i&&"mellis"!==i||"string"!=typeof e.name||""===e.name)return null;var i;const a=t=>"number"==typeof t&&Number.isFinite(t)?t:0;return{slot:e.slot,name:e.name,kcal:a(e.kcal),protein:a(e.protein),fat:a(e.fat),carbs:a(e.carbs),logged:!0===e.logged}}function je(t){if(!t||"object"!=typeof t)return null;const e=t;if("string"!=typeof e.date||!De.test(e.date))return null;const i=Array.isArray(e.meals)?e.meals.map(Be).filter(t=>null!==t):[];return{date:e.date,weekday:"string"==typeof e.weekday?e.weekday:"",day_type:"string"==typeof e.day_type?e.day_type:"vilodag",confirmed:!0===e.confirmed,meals:i,total_kcal:"number"==typeof e.total_kcal?e.total_kcal:0,target_kcal:"number"==typeof e.target_kcal?e.target_kcal:0,protein_ok:!0===e.protein_ok,kcal_ok:!1!==e.kcal_ok}}function Oe(t){if(!t)return null;const{week_start:e,today:i,days:a}=t;if("string"!=typeof e||!De.test(e))return null;if(!Array.isArray(a))return null;const s=a.map(je).filter(t=>null!==t);return 0===s.length?null:{weekStart:e,today:"string"==typeof i&&De.test(i)?i:e,confirmedDays:s.filter(t=>t.confirmed).length,days:s}}function Le(t){const e=t=>Fe.flatMap(e=>t.meals.filter(t=>t.slot===e&&!t.logged)),i=t.days.find(e=>e.date===t.today);if(i){const t=e(i);if(t.length>0)return{dayLabel:"Idag",day:i,meals:t}}const a=t.days.find(e=>e.date===function(t,e){const[i,a,s]=t.split("-").map(Number);return new Date(Date.UTC(i,a-1,s+e)).toISOString().slice(0,10)}(t.today,1));if(a){const t=e(a);if(t.length>0)return{dayLabel:"Imorgon",day:a,meals:t}}return null}const Ie=new Intl.NumberFormat("sv-SE");class Re extends mt{_model(){if(!this.plannerEntity)return null;const t=this.getEntity(this.plannerEntity);return t&&"unavailable"!==t.state&&"unknown"!==t.state?Oe(t.attributes):null}_open(){this.dispatchEvent(new CustomEvent("hub-goto-page",{detail:{page:"vecka"},bubbles:!0,composed:!0}))}render(){if(!this.hass||!this.plannerEntity)return q;const t=this._model(),e=t?Le(t):null;return V`
      <div class="card${e?"":" empty"}" @click=${this._open}>
        ...
        ${e?V`
              ...
              <div class="meals">
                ${e.meals.map(t=>V`
                    <div class="meal">
                      <span class="slot">${Ne[t.slot]}</span>
                      <span class="name">${t.name}</span>
                      <span class="kcal">${Ie.format(t.kcal)}</span>
                    </div>
                  `)}
              </div>
            `:V`<div class="none">${t?"Inget planerat ännu":"Vecka · offline"}</div>`}
      </div>
    `}}function He(t){const e=Date.parse(t.expected??t.scheduled??"");return Number.isNaN(e)?Number.POSITIVE_INFINITY:e}function Ue(t,e,i){if(!Array.isArray(t))return[];const a=i?new RegExp(i,"i"):null;return t.filter(t=>t?.line?.designation===e).filter(t=>!(a&&t.destination&&a.test(t.destination))).sort((t,e)=>He(t)-He(e))}Re.styles=[Tt,n`
      :host {
        display: block;
        height: 100%;
      }
    ...
    `],t([gt({attribute:!1})],Re.prototype,"plannerEntity",void 0),customElements.define("hub-meal-card",Re);function Ve(t){if(!Array.isArray(t))return[];const e=new Map;for(const i of t){if(!i||"object"!=typeof i)continue;const t=i;if("string"!=typeof t.header||0===t.header.length)continue;const a="number"==typeof t.priority?t.priority:0,s=Array.isArray(t.lines)?t.lines.map(t=>t&&"object"==typeof t?t.designation:null).filter(t=>"string"==typeof t&&t.length>0):[],r="string"==typeof t.details&&t.details.length>0?t.details:void 0,n="string"==typeof t.scope&&t.scope.length>0?t.scope:void 0,o=e.get(t.header);if(o){for(const t of s)o.badges.add(t);o.priority=Math.max(o.priority,a),!o.details&&r&&(o.details=r),!o.scope&&n&&(o.scope=n)}else e.set(t.header,{badges:new Set(s),priority:a,details:r,scope:n})}return[...e.entries()].sort((t,e)=>e[1].priority-t[1].priority).slice(0,5).map(([t,e])=>({badges:[...e.badges].sort(),header:t,...void 0!==e.details?{details:e.details}:{},...void 0!==e.scope?{scope:e.scope}:{}}))}const Xe=new Set(["unavailable","unknown",""]);function We(t){if(!t||Xe.has(t))return null;const e=new Date(t);if(Number.isNaN(e.getTime()))return null;return`${String(e.getHours()).padStart(2,"0")}:${String(e.getMinutes()).padStart(2,"0")}`}class qe extends mt{constructor(){super(...arguments),this._open=()=>{this.dispatchEvent(new CustomEvent("hub-transit-open",{bubbles:!0,composed:!0}))}}_pendeltag(){const t=this.config.transit?.pendeltag;if(!t)return V`<span class="sub dim">–</span>`;const e=this.getEntity(t.next_entity),i=We(e?.state);if(!i)return V`<span class="sub dim">–</span>`;const a=this.getEntity(t.count_entity),s=a&&!Number.isNaN(Number(a.state))?Number(a.state):null;return V`<span class="sub">Nästa ${i}${null===s?"":` · ${s} ${1===s?"avgång":"avgångar"}`}</span>`}_bus(){const t=this.config.transit?.bus;if(!t)return V`<span class="sub dim">Inga avgångar idag</span>`;const e=this.getEntity(t.entity),i=Ue(e?.attributes.departures??[],t.line,t.exclude_destination).slice(0,3);return 0===i.length?V`<span class="sub dim">Inga avgångar idag</span>`:V`<span class="sub"
      >${i.map((t,e)=>V`${e>0?V`<span class="sep">·</span>`:""}<span
            class="dep ${t.state&&"EXPECTED"!==t.state?"delayed":""}"
            >${t.display??"–"}</span
          >`)}</span
    >`}_shaped(){const t=this.config.disturbances_entity?this.getEntity(this.config.disturbances_entity):void 0;return t&&"unavailable"!==t.state&&"unknown"!==t.state?Ve(t.attributes.deviations):[]}_alerts(t){if(0===t.length)return q;if(1===t.length){const e=t[0];return V`<div class="alerts">
        <div class="alert">
    ...
    `],t([gt({attribute:!1})],qe.prototype,"config",void 0),customElements.define("hub-transit-card",qe);const Ge=36e5,Ye=new Set(["unavailable","unknown","none",""]);function Ke(t,e,i){if(!Array.isArray(t))return[];const a=[];for(const s of t){if(!s||"object"!=typeof s)continue;const t=s,r="number"==typeof t.total?t.total:Number(t.total);if(!Number.isFinite(r)||"string"!=typeof t.startsAt)continue;const n=new Date(t.startsAt);if(Number.isNaN(n.getTime()))continue;const o="number"==typeof t.energy?t.energy:Number(t.energy),l=Number.isFinite(o)?100*o:null,h=100*r,c="spot"===e&&null!==l?l:h+("allin"===e?i:0);a.push({start:n,ore:c,totalOre:h,spotOre:l})}return a.sort((t,e)=>t.start.getTime()-e.start.getTime())}function Ze(t){if(t.length<3)return null;let e=1/0,i=-1;for(let a=0;a+3<=t.length;a++){let s=!0,r=t[a].ore;for(let e=a+1;e<a+3;e++){if(t[e].start.getTime()-t[e-1].start.getTime()!==Ge){s=!1;break}r+=t[e].ore}s&&r<e&&(e=r,i=a)}return i<0?null:{start:t[i].start,end:new Date(t[i+3-1].start.getTime()+Ge)}}function Je(t,e,i,a="allin",s=0){if(Ye.has(String(e??"").toLowerCase()))return{now:null,level:"normal",today:[],tomorrow:[],cheapestWindow:null};const r=Ke(t?.today,a,s),n=Ke(t?.tomorrow,a,s);if(0===r.length&&0===n.length)return{now:null,level:"normal",today:[],tomorrow:[],cheapestWindow:null};const o=[...r,...n].sort((t,e)=>t.start.getTime()-e.start.getTime()),l=i.getTime(),h=o.find(t=>t.start.getTime()<=l&&l<t.start.getTime()+Ge)??null;let c="normal";if(h&&r.length){const t=r.reduce((t,e)=>t+e.ore,0)/r.length;if(t>0){const e=h.ore/t;e<.85?c="låg":e>1.15&&(c="hög")}}const d=o.filter(t=>t.start.getTime()+Ge>l);return{now:h,level:c,today:r,tomorrow:n,cheapestWindow:Ze(d)}}function Qe(t){const e=[...t.today,...t.tomorrow];return e.length>0&&e.every(t=>null!==t.spotOre)}const ti="glass-hub-price-view";function ei(){try{return"spot"===localStorage.getItem(ti)?"spot":"allin"}catch{return"allin"}}function ii(t){return(t?.grid?.overforing_ore??0)+(t?.grid?.energiskatt_ore??0)}const ai={"låg":"lågt",normal:"normalt","hög":"högt"};class si extends mt{constructor(){super(...arguments),this._now=new Date,this._open=()=>{this.dispatchEvent(new CustomEvent("hub-goto-page",{detail:{page:"energi"},bubbles:!0,composed:!0}))}}connectedCallback(){super.connectedCallback(),this._interval=window.setInterval(()=>{this._now=new Date},6e4)}disconnectedCallback(){super.disconnectedCallback(),void 0!==this._interval&&(clearInterval(this._interval),this._interval=void 0)}_model(){const t=this.config.price_series_entity?this.getEntity(this.config.price_series_entity):void 0;if(!t)return null;const e=ei(),i=t.attributes,a=Je(i,t.state,this._now,e,"allin"===e?ii(this.config):0);return"spot"===e&&a.today.length&&a.today.some(t=>null===t.spotOre)?Je(i,t.state,this._now,"allin",ii(this.config)):a}_currentOre(t){if(t?.now)return Math.round(t.now.ore);const e=this.config.price_entity?this.getEntity(this.config.price_entity):void 0;return e&&!Number.isNaN(Number(e.state))?Math.round(100*Number(e.state)):null}_bars(t){const e=function(t,e){const i=[...t.today,...t.tomorrow].sort((t,e)=>t.start.getTime()-e.start.getTime()),a=e.getTime(),s=t.cheapestWindow,r=s?s.start.getTime():null,n=s?s.end.getTime():null;return i.filter(t=>t.start.getTime()+Ge>a).slice(0,12).map(t=>{const e=t.start.getTime();return{start:t.start,ore:t.ore,current:e<=a&&a<e+Ge,cheap:null!==r&&e>=r&&e<n}})}(t,this._now);if(0===e.length)return V`<div class="waiting">Väntar på prisdata</div>`;const i=e.map(t=>t.ore),a=Math.min(...i),s=Math.max(...i)-a;return V`<div class="bars">
      ${e.map(t=>{return V`<div
        ...
        ></div>`;var e})}
          ...
          ><span class="ic">${Lt.clock}</span>Billigast ${n.start.getHours()}–${n.end.getHours()}</span
        >`:q;return V`
      <button class="card" aria-label=${null===e?"Elpris, öppna energisidan":`Elpris ${e} öre just nu${r?`, ${ai[a]}`:""}, öppna energisidan`} @click=${this._open}>
        <div class="head">
          <div class="lead">
            <span class="ic">${Lt.bolt}</span>
            <span class="num ${s}">${null===e?"—":e}</span>
            <span class="unit">öre</span>
            ${r?V`<span class="level ${s}">· ${ai[a]}</span>`:q}
          </div>
          ${o}
        </div>
    ...
    `],t([gt({attribute:!1})],si.prototype,"config",void 0),t([bt()],si.prototype,"_now",void 0),customElements.define("hub-energy-strip",si);const ri={cleaning:"Städar",returning:"Åker hem",paused:"Pausad",error:"Fel",idle:"Väntar"};class ni extends mt{constructor(){super(...arguments),this.theme="natt",this.weatherBg=!1,this.pageActive=!1}_gotoPage(t){this.dispatchEvent(new CustomEvent("hub-goto-page",{detail:{page:t},bubbles:!0,composed:!0}))}get _chips(){const t=this.config,e=[],i=t.lights_count_entity?this.getEntity(t.lights_count_entity):void 0,a=i&&!Number.isNaN(Number(i.state))?Number(i.state):null;if(e.push({icon:"lamp",label:null===a?"—":`${a} ${1===a?"lampa":"lampor"}`,tone:"amber",active:(a??0)>0}),t.vacuum_entity){const i=this.getEntity(t.vacuum_entity);i&&"docked"!==i.state&&"unavailable"!==i.state&&"unknown"!==i.state&&e.push({icon:"vacuum",label:ri[i.state]??"Städar",tone:"error"===i.state?"coral":"neutral",active:!0})}if(t.person_entity){const i=this.getEntity(t.person_entity),a=(i?.attributes.friendly_name||"Philip").split(" ")[0],s="home"===i?.state;e.push({icon:"home",label:`${a} ${s?"hemma":"borta"}`,tone:"neutral",active:!1})}return e}render(){if(!this.hass||!this.config)return V``;const t=this.config,e=this.weatherBg?"natt"===this.theme?"--hub-card:rgba(19,19,22,0.86);--hub-chip-bg:rgba(21,21,25,0.86);--hub-teal-bg:rgba(16,20,24,0.86);--hub-lavender-bg:rgba(20,18,23,0.86);":"--hub-card:rgba(255,255,255,0.88);--hub-chip-bg:rgba(255,255,255,0.88);--hub-teal-bg:rgba(255,255,255,0.88);--hub-lavender-bg:rgba(255,255,255,0.88);--hub-amber-bg:rgba(255,255,255,0.88);":"";return V`
    ...
    `],t([gt({attribute:!1})],li.prototype,"light",void 0),t([bt()],li.prototype,"_flash",void 0),customElements.define("hub-light-tile",li);const hi=new Set(["unavailable","unknown"]);function ci(t){return!!t&&!hi.has(t.state)}class di extends mt{constructor(){super(...arguments),this._armed=!1,this._flash=!1,this._headLongPressed=!1,this._headDownX=0,this._headDownY=0,this._onAllOff=()=>{if(!this._armed)return this._armed=!0,void 0!==this._armTimer&&clearTimeout(this._armTimer),void(this._armTimer=window.setTimeout(()=>{this._armed=!1,this._armTimer=void 0},3e3));void 0!==this._armTimer&&clearTimeout(this._armTimer),this._armTimer=void 0,this._armed=!1,this._flash=!0,this.callService("light","turn_off",void 0,"all"),void 0!==this._flashTimer&&clearTimeout(this._flashTimer),this._flashTimer=window.setTimeout(()=>{this._flash=!1,this._flashTimer=void 0},200)},this._onHeadMove=t=>{void 0!==this._headPressTimer&&(jt(t.clientX-this._headDownX)||jt(t.clientY-this._headDownY))&&this._cancelHeadPress()},this._cancelHeadPress=()=>{void 0!==this._headPressTimer&&(clearTimeout(this._headPressTimer),this._headPressTimer=void 0)}}disconnectedCallback(){super.disconnectedCallback(),this._clearTimers()}_clearTimers(){void 0!==this._armTimer&&clearTimeout(this._armTimer),void 0!==this._flashTimer&&clearTimeout(this._flashTimer),this._armTimer=void 0,this._flashTimer=void 0,this._armed=!1,this._flash=!1,this._cancelHeadPress()}_activateScene(t){this.callService("scene","turn_on",void 0,t)}_onHeadDown(t,e){this._headLongPressed=!1,this._headDownX=t.clientX,this._headDownY=t.clientY,this._headPressTimer=window.setTimeout(()=>{this._headLongPressed=!0,this.dispatchEvent(new CustomEvent("hub-room-open",{detail:{roomId:e.id},bubbles:!0,composed:!0}))},500)}_onHeadClick(t){if(this._headLongPressed)return void(this._headLongPressed=!1);const e=ke(t,this.hass.states);this.callService("light",e.service,{entity_id:e.entities})}_section(t){const e=function(t,e){const i=t.lights.filter(t=>"on"===e[t.entity]?.state),a=i.length;if(0===a)return{onCount:0,pct:null,label:"Släckt"};const s=i.map(t=>e[t.entity]?.attributes.brightness).filter(t=>"number"==typeof t),r=s.length?Math.round(s.reduce((t,e)=>t+e,0)/s.length/255*100):null,n=1===a?"1 lampa":`${a} lampor`;return{onCount:a,pct:r,label:null!==r?`${n} · ${r} %`:n}}(t,this.hass.states),i=e.onCount>0;return V`
      <div class="section">
        <div
    ...
    `}render(){if(!this.hass||!this.config)return V``;const t=this.config,e=function(t,e){let i=0,a=0;for(const s of t.rooms??[])for(const t of s.lights){const s=e[t.entity];ci(s)&&(a+=1,"on"===s.state&&(i+=1))}return{on:i,total:a}}(t,this.hass.states);return V`
      <div class="page">
        <div class="header">
          <div class="heading">
          ...
          <div class="actions">
            ${(t.scenes??[]).map(t=>V`
                ...
                >
                  ${Lt[t.icon]?V`<span class="ic">${Lt[t.icon]}</span>`:q}
                  <span>${t.name}</span>
                </button>
              `)}
            <button
    ...
    `],t([gt({attribute:!1})],pi.prototype,"model",void 0),t([gt({type:Number})],pi.prototype,"gridAddOre",void 0),t([bt()],pi.prototype,"_detail",void 0),customElements.define("hub-price-chart",pi);const ui={"låg":"lågt",normal:"normalt","hög":"högt"};class gi extends mt{constructor(){super(...arguments),this._now=new Date,this._view=ei()}connectedCallback(){super.connectedCallback(),this._interval=window.setInterval(()=>{this._now=new Date},6e4)}disconnectedCallback(){super.disconnectedCallback(),void 0!==this._interval&&(clearInterval(this._interval),this._interval=void 0)}_model(){const t=this.config.price_series_entity?this.getEntity(this.config.price_series_entity):void 0;if(!t)return null;const e=t.attributes;let i=Je(e,t.state,this._now,this._view,"allin"===this._view?ii(this.config):0);return"spot"!==this._view||Qe(i)||(i=Je(e,t.state,this._now,"allin",ii(this.config))),i}_setView(t){this._view=t,function(t){try{localStorage.setItem(ti,t)}catch{}}(t)}_currentOre(t){if(t?.now)return Math.round(t.now.ore);const e=this.config.price_entity?this.getEntity(this.config.price_entity):void 0;return e&&!Number.isNaN(Number(e.state))?Math.round(100*Number(e.state)):null}_chips(t){const e=this.config,i=[],a=e.co2_entity?this.getEntity(e.co2_entity):void 0;a&&!Number.isNaN(Number(a.state))&&i.push({icon:"leaf",label:`${Math.round(Number(a.state))} g CO₂`,tone:"green"});const s=e.fossil_entity?this.getEntity(e.fossil_entity):void 0;if(s&&!Number.isNaN(Number(s.state))){const t=Math.round(Number(s.state));i.push({icon:"leaf",label:`${t} % fossilt`,tone:t>=40?"coral":"green"})}const r=t?.cheapestWindow;if(r){const t=r.start.getHours(),e=r.end.getHours();i.push({icon:"clock",label:`Billigast ${t}–${e}`,tone:"green"})}return i}render(){if(!this.hass||!this.config)return V``;const t=this._model(),e=this._currentOre(t),i=t?.now?t.level:"normal",a=!!t&&t.today.length>0,s=this._chips(t),r=!!t&&Qe(t),n="låg"===i?"low":"hög"===i?"high":"",o=!!t?.now&&"normal"!==i;return V`
      <div class="page">
        <div class="header">
          <div class="head-row">
            <div>
        ...
        <div class="chart-wrap">
          ${a?V`<hub-price-chart .model=${t} .gridAddOre=${ii(this.config)}></hub-price-chart>`:V`<div class="waiting">Väntar på prisdata</div>`}
        </div>
    ...
    `],t([gt({attribute:!1})],mi.prototype,"player",void 0),t([gt({attribute:!1})],mi.prototype,"groupMaster",void 0),t([bt()],mi.prototype,"_drag",void 0),customElements.define("hub-volume-row",mi);const fi=new Set(["off","unavailable","unknown","standby","idle"]);function xi(t){const e=Number.isFinite(t)&&t>0?t:0,i=Math.floor(e/60),a=Math.floor(e%60);return`${i}:${String(a).padStart(2,"0")}`}class yi extends mt{constructor(){super(...arguments),this._sel=null,this._rgb=null,this._now=Date.now()}connectedCallback(){super.connectedCallback(),this._interval=window.setInterval(()=>{this._now=Date.now()},1e3)}disconnectedCallback(){super.disconnectedCallback(),void 0!==this._interval&&(clearInterval(this._interval),this._interval=void 0)}get _players(){return this.config?.media_players??[]}_selId(){if(this._sel)return this._sel;const t=Ce(this.hass?.states??{},this._players);return t?.entity.entity_id??this._players[0]?.entity??null}_theme(){const t=this.getRootNode()?.host;return"dag"===t?.getAttribute("data-theme")?"dag":"natt"}updated(t){const e=this._selId(),i=e?this.hass?.states[e]?.attributes.entity_picture:void 0;i!==this._pic&&(this._pic=i,i?bi(i).then(t=>{this._pic===i&&(this._rgb=t)}):this._rgb=null)}_transport(t,e){this.callService("media_player",t,void 0,e)}_hero(t,e){const i="playing"===t.state,a=t.attributes.media_title||e,s=t.attributes.media_artist||e,r=t.attributes.entity_picture,n="number"==typeof t.attributes.media_duration?t.attributes.media_duration:0,o=Se(t,this._now),l=o/100*n,h=t.entity_id;return V`
      <div class="hero">
    ...
    `],t([gt({attribute:!1})],yi.prototype,"config",void 0),t([bt()],yi.prototype,"_sel",void 0),t([bt()],yi.prototype,"_rgb",void 0),t([bt()],yi.prototype,"_now",void 0),customElements.define("hub-media-page",yi);let _i=0;class wi extends ht{constructor(){super(...arguments),this.points=[],this.stroke="--hub-lavender",this.width=560,this.height=130,this._gid="hub-spark-"+_i++}render(){const t=function(t,e,i,a=.1){const s=t.length;if(0===s)return[];if(1===s)return[{x:e,y:i/2}];const r=t.map(t=>t.value),n=Math.min(...r),o=Math.max(...r)-n,l=n-o*a,h=o*(1+2*a);return t.map((t,a)=>({x:a/(s-1)*e,y:o<=0?i/2:i-(t.value-l)/h*i}))}(this.points,this.width,this.height);if(0===t.length)return V``;const e=t.map(t=>`${t.x.toFixed(2)},${t.y.toFixed(2)}`).join(" "),i=t[t.length-1],a=t[0],s=t.length>=2,r=`${e} ${i.x.toFixed(2)},${this.height} ${a.x.toFixed(2)},${this.height}`;return V`
  ...
  `,t([gt({attribute:!1})],wi.prototype,"points",void 0),t([gt()],wi.prototype,"stroke",void 0),t([gt({type:Number})],wi.prototype,"width",void 0),t([gt({type:Number})],wi.prototype,"height",void 0),customElements.define("hub-sparkline",wi);const ki=new Intl.NumberFormat("sv-SE"),$i=new Intl.NumberFormat("sv-SE",{minimumFractionDigits:1,maximumFractionDigits:1}),Ei=new Intl.NumberFormat("sv-SE",{maximumFractionDigits:1}),Ci=new Intl.DateTimeFormat("sv-SE",{day:"numeric",month:"short",timeZone:"UTC"}),Si=new Intl.DateTimeFormat("sv-SE",{weekday:"long",day:"numeric",month:"long",timeZone:"UTC"});function Mi(t){if(!t)return"";const e=new Date(`${t}T00:00:00Z`);return Number.isNaN(e.getTime())?"":Ci.format(e).replace(/\.$/,"")}class Ai extends mt{_meals(t){const e=t.attributes.meals;return Array.isArray(e)?e.filter(t=>!!t&&"object"==typeof t).map(t=>({name:"string"==typeof t.name?t.name:"",kcal:"number"==typeof t.kcal?t.kcal:Number(t.kcal)||0})).filter(t=>t.name):[]}_num(t){return"number"==typeof t?t:NaN}_offline(){return V`
      <div class="page">
        <div class="offline">
    ...
    `}_weightCard(){const t=this.config.kcal?.forecast_entity,e=t?this.getEntity(t):void 0,i=e?Number(e.state):NaN;if(!e||"unavailable"===e.state||"unknown"===e.state||Number.isNaN(i))return V`
      ...
      `;const a=e.attributes.weight_trend,s=Array.isArray(a)?a.filter(t=>!!t&&"object"==typeof t).map(t=>({date:String(t.date??""),value:Number(t.kg)})).filter(t=>Number.isFinite(t.value)):[],r=function(t){if(t.length<2)return null;const e=new Date(`${t[0].date}T00:00:00Z`).getTime(),i=new Date(`${t[t.length-1].date}T00:00:00Z`).getTime();return Number.isNaN(e)||Number.isNaN(i)?null:Math.round((i-e)/864e5)}(s),n=s.length>=2?s[s.length-1].value-s[0].value:null,o=null===n||null===r?null:`${n<0?"−":n>0?"+":""}${$i.format(Math.abs(n))} kg på ${r} ${1===r?"dag":"dagar"}`,l=e.attributes.forecast,h=l&&"object"==typeof l?l:null,c=h?function(t){const e="number"==typeof t.goal_kg?`Mål ${Ei.format(t.goal_kg)} kg`:"",i=t.eta?Mi(t.eta):"",a=t.eta_early&&t.eta_late?`${Mi(t.eta_early)}–${Mi(t.eta_late)}`:"";return[e,i?`ETA ${i}${a?` (${a})`:""}`:""].filter(Boolean).join(" · ")}(h):"",d=!!h?.on_track;return V`
      <section class="card">
        <span class="w-eyebrow">Vikt</span>
        <div class="w-num-row">
          <span class="w-num">${$i.format(i)}</span>
    ...
    `}render(){if(!this.hass||!this.config)return V``;const t=this.config.kcal?.today_entity,e=t?this.getEntity(t):void 0,i=e?Number(e.state):NaN;if(!e||"unavailable"===e.state||"unknown"===e.state||Number.isNaN(i))return this._offline();const a=this._num(e.attributes.kcal_target),s=Te(i,a),r=Number.isFinite(a)&&a>0,n=r?a-i:NaN,o=r?n>0?`${ki.format(Math.round(n))} kcal kvar`:0===n?"Målet nått":`${ki.format(Math.round(-n))} över målet`:null,l=this._num(e.attributes.protein_g),h=this._num(e.attributes.protein_target_g),c=Number.isFinite(l)&&Number.isFinite(h)&&h>0,d=c?Math.max(0,Math.min(100,l/h*100)):0,p=this._meals(e),u=e.attributes.date,g="string"!=typeof u||Number.isNaN(new Date(`${u}T00:00:00Z`).getTime())?"":Si.format(new Date(`${u}T00:00:00Z`));return V`
      <div class="page">
        <div class="header">
          ...
          <section class="card">
            <div class="ring-wrap">
              ...
              <div class="ring-center">
                <span class="kc-num">${ki.format(Math.round(i))}</span>
                <span class="kc-target">
                  ${r?`/ ${ki.format(a)} kcal`:"kcal"}
                </span>
              </div>
            </div>
            ...
            <div class="meals">
              ...
              ${p.length?p.map(t=>V`
                      <div class="meal">
                        ...
                        <span class="meal-kcal">${ki.format(Math.round(t.kcal))} kcal</span>
                      </div>
    ...
    `],t([gt({attribute:!1})],Ai.prototype,"config",void 0),customElements.define("hub-kcal-page",Ai);const Ti=new Intl.NumberFormat("sv-SE"),Pi=new Intl.DateTimeFormat("sv-SE",{weekday:"long",day:"numeric",month:"long",timeZone:"UTC"});class Ni extends mt{constructor(){super(...arguments),this._openDate=null,this._confirming=!1}_model(){const t=this.config?.kcal?.planner_entity;if(!t)return null;const e=this.getEntity(t);return e&&"unavailable"!==e.state&&"unknown"!==e.state?Oe(e.attributes):null}_confirm(t){this._confirming||t.confirmed||0===t.meals.length||(this._confirming=!0,this.callService("rest_command","kcal_confirm_day",{date:t.date}),window.setTimeout(()=>{const t=this.config?.kcal?.planner_entity;t&&this.callService("homeassistant","update_entity",void 0,t),this._confirming=!1,this._openDate=null},1500))}_dayPopup(t){const e=t.days.find(t=>t.date===this._openDate);if(!e)return q;const i=Pi.format(new Date(`${e.date}T00:00:00Z`)),a=!e.confirmed&&e.meals.some(t=>!t.logged);return V`
      <div class="scrim" @click=${()=>this._openDate=null}>
        <div class="popup" @click=${t=>t.stopPropagation()}>
          <h2 class="popup-title">${i}</h2>
          <div class="popup-sub">
            ${e.day_type} · ${Ti.format(e.total_kcal)} / ${Ti.format(e.target_kcal)} kcal
            ${e.confirmed?" · bekräftad ✓":""}
          </div>
          ${e.meals.map(t=>V`
              <div class="pm">
                <div>
                  <span class="pm-slot">${Ne[t.slot]}${t.logged?" · loggad":""}</span>
                  <span class="pm-name">${t.name}</span>
                </div>
                <span class="pm-macro">
                  ${Ti.format(t.kcal)} kcal<br />
                  P ${Ti.format(t.protein)} · F ${Ti.format(t.fat)} · K ${Ti.format(t.carbs)}
                </span>
              </div>
            `)}
    ...
    `}_dayCard(t,e){const i=Fe.filter(e=>t.meals.some(t=>t.slot===e));return V`
      <button
      ...
      >
        <div class="day-head">
          ...
          <span class="type-chip ${t.day_type}">${a=t.day_type,ze[a]??"·"}</span>
        </div>
        <div class="slots">
          ${0===i.length?V`<span class="empty-day">—</span>`:q}
          ${i.map(e=>V`
              <div>
                <span class="slot-label">${Ne[e]}</span>
                ${t.meals.filter(t=>t.slot===e).map(t=>V`
                      <div class="meal">
                        <span class="meal-name${t.logged?" logged":""}">${t.name}</span>
                        <span class="meal-kcal">${Ti.format(t.kcal)} kcal</span>
                      </div>
                    `)}
              </div>
            `)}
        ...
        <div class="day-foot">
          ${t.meals.length>0?V`${Ti.format(t.total_kcal)} / ${Ti.format(t.target_kcal)}
    ...
    `:V`<div class="page"><div class="offline">Vecka · offline</div></div>`}}Ni.styles=[Tt,n`
      :host {
        display: block;
        height: 100%;
    ...
    `],t([gt({attribute:!1})],Ni.prototype,"config",void 0),t([bt()],Ni.prototype,"_openDate",void 0),t([bt()],Ni.prototype,"_confirming",void 0),customElements.define("hub-planner-page",Ni);const Fi=X`
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round">
    <path d="M6 6l12 12M18 6L6 18"></path>
  </svg>
`;class zi extends mt{constructor(){super(...arguments),this.room=null,this._onScrim=t=>{t.target===t.currentTarget&&this._close()}}_close(){this.dispatchEvent(new CustomEvent("hub-popup-close",{bubbles:!0,composed:!0}))}_activateScene(t){this.callService("scene","turn_on",void 0,t)}render(){if(!this.room||!this.hass)return V``;const t=this.room;return V`
    ...
    `],t([gt({attribute:!1})],zi.prototype,"room",void 0),customElements.define("hub-room-popup",zi);const Di=X`
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round">
    <path d="M6 6l12 12M18 6L6 18"></path>
  </svg>
`;class Bi extends mt{constructor(){super(...arguments),this.entity="",this.name="",this._onScrim=t=>{t.target===t.currentTarget&&this._close()}}_close(){this.dispatchEvent(new CustomEvent("hub-popup-close",{bubbles:!0,composed:!0}))}render(){return this.entity&&this.hass?V`
      <div class="scrim" @click=${this._onScrim}>
    ...
    `],t([gt()],Bi.prototype,"entity",void 0),t([gt()],Bi.prototype,"name",void 0),customElements.define("hub-light-popup",Bi);const ji=X`
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round">
    <path d="M6 6l12 12M18 6L6 18"></path>
  </svg>
`,Oi=new Set(["EXPECTED","ATSTOP"]);class Li extends mt{constructor(){super(...arguments),this._onScrim=t=>{t.target===t.currentTarget&&this._close()}}_close(){this.dispatchEvent(new CustomEvent("hub-popup-close",{bubbles:!0,composed:!0}))}_departures(t,e,i){if(!t)return[];const a=this.getEntity(t);return Ue(a?.attributes.departures??[],e,i).slice(0,6)}_depRow(t){const e=function(t){return"string"==typeof t.state&&t.state.length>0&&!Oi.has(t.state)}(t),i=We(t.expected??t.scheduled)??"–";return V`
      <div class="dep-row">
    ...
    `}render(){if(!this.hass||!this.config)return V``;const t=this.config,e=this._departures(t.departures?.list_entity,"43",""),i=t.transit?.bus,a=i?this._departures(i.entity,i.line,i.exclude_destination):[],s=t.disturbances_entity?this.getEntity(t.disturbances_entity):void 0,r=s&&"unavailable"!==s.state&&"unknown"!==s.state?Ve(s.attributes.deviations):[];return V`
      <div class="scrim" @click=${this._onScrim}>
    ...
    `],t([gt({attribute:!1})],Li.prototype,"config",void 0),customElements.define("hub-transit-popup",Li);const Ii=X`
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round">
    <path d="M6 6l12 12M18 6L6 18"></path>
  </svg>
`,Ri=new Intl.DateTimeFormat("sv-SE",{weekday:"short"});class Hi extends mt{constructor(){super(...arguments),this._loc=0,this._hours=[],this._days=[],this._bgOn=Ft(),this._loadedFor="",this._onScrim=t=>{t.target===t.currentTarget&&this._close()}}get _locations(){const t=this.config;return t?.weather_locations?.length?t.weather_locations:t?.weather_entity?[{entity:t.weather_entity,name:"Hem"}]:[]}updated(t){const e=this._locations[this._loc]?.entity;e&&this.hass&&(t.has("hass")||t.has("config"))&&this._loadedFor!==e&&this._load(e)}async _load(t){this._loadedFor=t;const[e,i]=await Promise.all([xe(this.hass,t,"hourly"),xe(this.hass,t,"daily")]);this._loadedFor===t&&(this._hours=e?Wt(e):[],this._days=i?qt(i):[])}_pickLoc(t){if(t===this._loc)return;this._loc=t,this._hours=[],this._days=[];const e=this._locations[t]?.entity;e&&this._load(e)}_close(){this.dispatchEvent(new CustomEvent("hub-popup-close",{bubbles:!0,composed:!0}))}_toggleBg(){this._bgOn=!this._bgOn,zt(this._bgOn),this.dispatchEvent(new CustomEvent("hub-weather-bg-toggle",{detail:{on:this._bgOn},bubbles:!0,composed:!0}))}get _isNight(){return"below_horizon"===this.hass?.states["sun.sun"]?.state}_hero(){const t=this.getEntity(this._locations[this._loc]?.entity??"");if(!t)return q;const e=t.attributes.temperature,i=t.attributes.apparent_temperature,a=t.attributes.wind_speed,s=t.attributes.wind_speed_unit??"km/h";return V`
      <div class="hero">
    ...
    `}_daily(){const t=this._days.slice(0,7),e=function(t){if(0===t.length)return null;let e=1/0,i=-1/0;for(const a of t)null!==a.low&&a.low<e&&(e=a.low),a.high>i&&(i=a.high),a.high<e&&(e=Math.min(e,a.high));return Number.isFinite(e)&&Number.isFinite(i)?{min:e,max:i}:null}(t),i=e?Math.max(e.max-e.min,1):1;return V`
      <div class="section">
        ...
        ${t.length&&e?t.map((t,a)=>{const s=t.low??t.high,r=(s-e.min)/i*100,n=Math.max((t.high-s)/i*100,4);return V`
                <div class="day-row">
                  <span class="day-name">${0===a?"Idag":function(t){return t.length?t.charAt(0).toUpperCase()+t.slice(1):t}(Ri.format(new Date(t.ts)))}</span>
                  ${me(t.condition,!1)}
    ...
    `],t([gt({attribute:!1})],Vi.prototype,"pages",void 0),t([gt({type:Number})],Vi.prototype,"active",void 0),customElements.define("hub-nav-bar",Vi);const Xi=["hem","ljus","media","energi","kcal","vecka"],Wi={hem:"Hem",ljus:"Ljus",media:"Media",energi:"Energi",kcal:"Kcal",vecka:"Vecka"};const qi=["auto","dag","natt"];let Gi=0;class Yi extends mt{constructor(){super(...arguments),this.theme="natt",this.kiosk=new URLSearchParams(location.search).has("kiosk"),this._page=0,this._dragX=0,this._openRoom=null,this._openLight=null,this._openTransit=!1,this._openWeather=!1,this._weatherBgOn=Ft(),this._override=function(){const t=localStorage.getItem(Pt);return"natt"===t||"dag"===t?t:"auto"}(),this._pointerActive=!1,this._dragging=!1,this._startX=0,this._startY=0,this._lastX=0,this._lastT=0,this._velocity=0,this._onRoomOpen=t=>{const e=t.detail?.roomId;this._openRoom=this._cfg?.rooms?.find(t=>t.id===e)??null},this._onLightOpen=t=>{const e=t.detail;this._openLight=e?.entity?{entity:e.entity,name:e.name??e.entity}:null},this._onGotoPage=t=>{const e=t.detail?.page;e&&this.goToPage(e)},this._onTransitOpen=()=>{this._openTransit=!0},this._onWeatherOpen=()=>{this._openWeather=!0},this._onWeatherBgToggle=t=>{this._weatherBgOn=t.detail?.on??Ft(),zt(this._weatherBgOn)},this._onPopupClose=()=>{this._openRoom=null,this._openLight=null,this._openTransit=!1,this._openWeather=!1},this._onAnyInteraction=()=>{this._resetIdle()},this._onPointerDown=t=>{this._pointerActive=!0,this._dragging=!1,this._startX=t.clientX,this._startY=t.clientY,this._lastX=t.clientX,this._lastT=t.timeStamp,this._velocity=0,this._dragX=0},this._onPointerMove=t=>{if(!this._pointerActive)return;const e=t.clientX-this._startX,i=t.clientY-this._startY;if(!this._dragging){if(!jt(e)&&!jt(i))return;if(!function(t,e){return Math.abs(t)>Math.abs(e)}(e,i))return void(this._pointerActive=!1);this._dragging=!0,t.currentTarget.setPointerCapture?.(t.pointerId),this._lastX=t.clientX,this._lastT=t.timeStamp}const a=t.timeStamp-this._lastT;a>0&&(this._velocity=(t.clientX-this._lastX)/a),this._lastX=t.clientX,this._lastT=t.timeStamp,this._dragX=e},this._onPointerUp=t=>{if(!this._pointerActive)return;const e=this._dragging;if(this._pointerActive=!1,this._dragging=!1,e){t.currentTarget.releasePointerCapture?.(t.pointerId);const e=this.clientWidth||window.innerWidth;this._page=function(t,e,i,a,s){const r=.2*e,n=Math.abs(i)>.5;let o=a;return t<-r||n&&i<-.5?o=a+1:(t>r||n&&i>.5)&&(o=a-1),Math.max(0,Math.min(s-1,o))}(this._dragX,e,this._velocity,this._page,this._pages.length),Gi=this._page}this._dragX=0,this._velocity=0}}setConfig(t){super.setConfig(t)}get _cfg(){return this._config}get _pages(){return this._cfg?.pages??Xi}connectedCallback(){super.connectedCallback(),function(){if(document.getElementById("glass-hub-fonts"))return;const t=document.createElement("style");t.id="glass-hub-fonts",t.textContent="\n@font-face{font-family:'Outfit';src:url('/local/glass-cards/fonts/outfit-variable.woff2') format('woff2-variations');font-weight:100 900;font-display:swap;}\n@font-face{font-family:'Inter';src:url('/local/glass-cards/fonts/inter-variable.woff2') format('woff2-variations');font-weight:100 900;font-display:swap;}\n",document.head.appendChild(t)}(),this._applyTheme(),this._page=Gi,this._resetIdle(),this._startKioskDrawerShim(),function(){const t=new URLSearchParams(location.search).get("weather");t&&(Dt=t),window.__hubForceWeather=t=>{Dt=t,window.dispatchEvent(new CustomEvent("hub-weather-force"))}}(),this.addEventListener("pointerdown",this._onAnyInteraction),this.addEventListener("hub-room-open",this._onRoomOpen),this.addEventListener("hub-light-open",this._onLightOpen),this.addEventListener("hub-transit-open",this._onTransitOpen),this.addEventListener("hub-goto-page",this._onGotoPage),this.addEventListener("hub-popup-close",this._onPopupClose),this.addEventListener("hub-weather-open",this._onWeatherOpen),this.addEventListener("hub-weather-bg-toggle",this._onWeatherBgToggle)}disconnectedCallback(){super.disconnectedCallback(),this._clearIdle(),void 0!==this._kioskTimer&&(clearInterval(this._kioskTimer),this._kioskTimer=void 0),this.removeEventListener("pointerdown",this._onAnyInteraction),this.removeEventListener("hub-room-open",this._onRoomOpen),this.removeEventListener("hub-light-open",this._onLightOpen),this.removeEventListener("hub-transit-open",this._onTransitOpen),this.removeEventListener("hub-goto-page",this._onGotoPage),this.removeEventListener("hub-popup-close",this._onPopupClose),this.removeEventListener("hub-weather-open",this._onWeatherOpen),this.removeEventListener("hub-weather-bg-toggle",this._onWeatherBgToggle)}willUpdate(t){t.has("hass")&&this._applyTheme()}goToPage(t){const e=this._pages.indexOf(t);e>=0&&(this._page=e,Gi=e,this._dragX=0)}_applyTheme(){const t=this.hass?.states["sun.sun"]?.attributes?.elevation,e="number"==typeof t?t:null;this.theme=function(t,e,i=4){return"auto"!==e?e:null===t?"natt":t>i?"dag":"natt"}(e,this._override,this._cfg?.day_elevation??4)}_cycleTheme(){const t=qi.indexOf(this._override);this._override=qi[(t+1)%qi.length],function(t){localStorage.setItem(Pt,t)}(this._override),this._applyTheme()}_toggleKiosk(){const t=new URLSearchParams(location.search);t.has("kiosk")?t.delete("kiosk"):t.set("kiosk","true");const e=t.toString();location.assign(location.pathname+(e?`?${e}`:""))}_resetIdle(){this._clearIdle();const t=this._cfg?.idle_return_s??120;this._idleTimer=window.setTimeout(()=>{0!==this._page&&this.goToPage(this._pages[0])},1e3*t)}_clearIdle(){void 0!==this._idleTimer&&(clearTimeout(this._idleTimer),this._idleTimer=void 0)}_startKioskDrawerShim(){if(!new URLSearchParams(location.search).has("kiosk"))return;const t=Date.now(),e=()=>{const t=document.querySelector("home-assistant")?.shadowRoot?.querySelector("home-assistant-main");if(!t)return!1;t.style.setProperty("--mdc-drawer-width","0px");const e=t.shadowRoot?.querySelector("ha-drawer");return e?.style.setProperty("--mdc-drawer-width","0px"),!0};e()||(this._kioskTimer=window.setInterval(()=>{(e()||Date.now()-t>5e3)&&(clearInterval(this._kioskTimer),this._kioskTimer=void 0)},250))}_themeGlyph(){return"auto"===this._override?V`<span class="glyph-auto">A</span>`:"dag"===this._override?X`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"
                      ...
                      ></hub-energy-page>`:"media"===e?V`<hub-media-page
                        ...
                        ></hub-media-page>`:"kcal"===e?V`<hub-kcal-page
                          ...
                          ></hub-kcal-page>`:"vecka"===e?V`<hub-planner-page
                              .hass=${this.hass}
                              .config=${this._cfg}
                            ></hub-planner-page>`:V`<h1 class="page-placeholder">${function(t){return Wi[t]??t.charAt(0).toUpperCase()+t.slice(1)}(e)}</h1>`}
            </section>
          `)}
      </div>
      ...
      <hub-nav-bar .pages=${t} .active=${this._page}>
        ...
        >
          ${this.kiosk?Lt.compress:Lt.expand}
        </button>
        <button
          slot="controls"
          class="theme-toggle"
